...
import { NodeTimeInfo, _pi } from "./blend.js";
...
export class Animation extends Node {
    constructor(properties, name) {
        ...
        this.loop_mode = 0;
        this.play_mode = PLAY_MODE_FORWARD;
        this.start_offset = 0;
        this.stretch_time_scale = false;
        this.timeline_length = 0;
        this.use_custom_timeline = false;
    ...
    blend_animation(p_playback_info) {
