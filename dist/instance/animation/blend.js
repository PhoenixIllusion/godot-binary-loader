...
export class NodeTimeInfo {
    constructor() {
        ...
        this.loop_mode = Animation.LoopMode.LOOP_NONE;
        this.will_end = false; // For breaking loop, it is true when just looped.
        this.is_infinity = false; // For unpredictable state machine's end.
    }
    is_looping() {
        return this.loop_mode != Animation.LoopMode.LOOP_NONE;
    }
    get_remain(p_break_loop = false) {
...
export function allocPlaybackInfo() {
    return {
...
export function clonePlaybackInfo(source) {
    return Object.assign({}, source);
    ;
}
export function blend_node($this, p_node, p_playback_info, p_filter, p_sync) {
