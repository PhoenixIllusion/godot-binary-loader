...
export namespace PhysicsBody3D {
}
...
export namespace SpriteBase3D {export const enum DrawFlags {
  FLAG_TRANSPARENT = 0,
  FLAG_SHADED = 1,
  FLAG_DOUBLE_SIDED = 2,
...
export const enum AlphaCutMode {
...
export namespace RDSamplerState {
}
...
export namespace ResourcePreloader {
}
...
export namespace MeshInstance3D {
}
...
export namespace OccluderPolygon2D {export const enum CullMode {
  CULL_DISABLED = 0,
  CULL_CLOCKWISE = 1,
...
export namespace XMLParser {export const enum NodeType {
  NODE_NONE = 0,
  NODE_ELEMENT = 1,
  NODE_ELEMENT_END = 2,
  NODE_TEXT = 3,
...
export interface Material extends Resource {
  next_pass: { type: "Material" , properties: Material };
  render_priority: type.int;  
}

export namespace Material {
export const RENDER_PRIORITY_MAX = 127;
export const RENDER_PRIORITY_MIN = -128;
}


export interface TextureLayeredRD extends TextureLayered {
  texture_rd_rid: { type: "RID" , properties: RID };  
}

export namespace TextureLayeredRD {
}
...
export namespace StreamPeerExtension {
}
...
export interface Viewport extends Node {
  ...
  use_xr: type.bool;
  vrs_mode: type.int;
  vrs_texture: { type: "Texture2D" , properties: Texture2D };
  vrs_update_mode: type.int;
  world_2d: { type: "World2D" , properties: World2D };
  world_3d: { type: "World3D" , properties: World3D };  
}

export namespace Viewport {export const enum PositionalShadowAtlasQuadrantSubdiv {
...
export const enum Scaling3DMode {
...
export const enum ScreenSpaceAA {
  SCREEN_SPACE_AA_DISABLED = 0,
  SCREEN_SPACE_AA_FXAA = 1,
  SCREEN_SPACE_AA_MAX = 2,
}

export const enum RenderInfo {
...
export const enum RenderInfoType {
...
export const enum DefaultCanvasItemTextureFilter {
...
export const enum DefaultCanvasItemTextureRepeat {
...
export const enum VRSUpdateMode {
...
export interface AudioStreamPlayer3D extends Node3D {
  ...
  playing: type.bool;
  stream: { type: "AudioStream" , properties: AudioStream };
  stream_paused: type.bool;
  unit_size: type.float;
  volume_db: type.float;  
}

export namespace AudioStreamPlayer3D {export const enum AttenuationModel {
...
export const enum DopplerTracking {
...
export namespace SphereShape3D {
}


export interface ParticleProcessMaterial extends Material {
  alpha_curve: { type: "Texture2D" , properties: Texture2D };
  angle_curve: { type: "Texture2D" , properties: Texture2D };
  angle_max: type.float;
  angle_min: type.float;
  angular_velocity_curve: { type: "Texture2D" , properties: Texture2D };
  angular_velocity_max: type.float;
  angular_velocity_min: type.float;
  anim_offset_curve: { type: "Texture2D" , properties: Texture2D };
  anim_offset_max: type.float;
  anim_offset_min: type.float;
  anim_speed_curve: { type: "Texture2D" , properties: Texture2D };
  ...
  color: type.Color;
  color_initial_ramp: { type: "Texture2D" , properties: Texture2D };
  color_ramp: { type: "Texture2D" , properties: Texture2D };
  damping_curve: { type: "Texture2D" , properties: Texture2D };
  damping_max: type.float;
  damping_min: type.float;
  direction: type.Vector3;
  directional_velocity_curve: { type: "Texture2D" , properties: Texture2D };
  directional_velocity_max: type.float;
  directional_velocity_min: type.float;
  emission_box_extents: type.Vector3;
  emission_color_texture: { type: "Texture2D" , properties: Texture2D };
  emission_curve: { type: "Texture2D" , properties: Texture2D };
  emission_normal_texture: { type: "Texture2D" , properties: Texture2D };
  emission_point_count: type.int;
  emission_point_texture: { type: "Texture2D" , properties: Texture2D };
  ...
  hue_variation_curve: { type: "Texture2D" , properties: Texture2D };
  ...
  linear_accel_curve: { type: "Texture2D" , properties: Texture2D };
  linear_accel_max: type.float;
  linear_accel_min: type.float;
  orbit_velocity_curve: { type: "Texture2D" , properties: Texture2D };
  ...
  radial_accel_curve: { type: "Texture2D" , properties: Texture2D };
  radial_accel_max: type.float;
  radial_accel_min: type.float;
  radial_velocity_curve: { type: "Texture2D" , properties: Texture2D };
  radial_velocity_max: type.float;
  radial_velocity_min: type.float;
  scale_curve: { type: "Texture2D" , properties: Texture2D };
  scale_max: type.float;
  scale_min: type.float;
  scale_over_velocity_curve: { type: "Texture2D" , properties: Texture2D };
  ...
  tangential_accel_curve: { type: "Texture2D" , properties: Texture2D };
  ...
  turbulence_influence_over_life: { type: "Texture2D" , properties: Texture2D };
  ...
  velocity_limit_curve: { type: "Texture2D" , properties: Texture2D };
  velocity_pivot: type.Vector3;  
}

export namespace ParticleProcessMaterial {export const enum Parameter {
...
export const enum EmissionShape {
...
export const enum SubEmitterMode {
...
export interface TextureProgressBar extends Range {
  ...
  texture_over: { type: "Texture2D" , properties: Texture2D };
  texture_progress: { type: "Texture2D" , properties: Texture2D };
  texture_progress_offset: type.Vector2;
  texture_under: { type: "Texture2D" , properties: Texture2D };
  tint_over: type.Color;
  tint_progress: type.Color;
  tint_under: type.Color;  
}

export namespace TextureProgressBar {export const enum FillMode {
...
export namespace PropertyTweener {
}
...
export namespace VisualShaderNodeFloatConstant {
}
...
export namespace MarginContainer {
}
...
export namespace AudioEffectDistortion {export const enum Mode {
  MODE_CLIP = 0,
  MODE_ATAN = 1,
  MODE_LOFI = 2,
  MODE_OVERDRIVE = 3,
...
export interface TextMesh extends PrimitiveMesh {
  ...
  depth: type.float;
  font: { type: "Font" , properties: Font };
  font_size: type.int;
...
export namespace AnimationNodeSub2 {
}
...
export interface ProjectSettings extends Object {
  ...
  'application/config/name_localized': { type: "Dictionary" , properties: Dictionary };
  ...
  'input/ui_accept': { type: "Dictionary" , properties: Dictionary };
  'input/ui_cancel': { type: "Dictionary" , properties: Dictionary };
  'input/ui_copy': { type: "Dictionary" , properties: Dictionary };
  'input/ui_cut': { type: "Dictionary" , properties: Dictionary };
  'input/ui_down': { type: "Dictionary" , properties: Dictionary };
  'input/ui_end': { type: "Dictionary" , properties: Dictionary };
  'input/ui_filedialog_refresh': { type: "Dictionary" , properties: Dictionary };
  'input/ui_filedialog_show_hidden': { type: "Dictionary" , properties: Dictionary };
  'input/ui_filedialog_up_one_level': { type: "Dictionary" , properties: Dictionary };
  'input/ui_focus_next': { type: "Dictionary" , properties: Dictionary };
  'input/ui_focus_prev': { type: "Dictionary" , properties: Dictionary };
  'input/ui_graph_delete': { type: "Dictionary" , properties: Dictionary };
  'input/ui_graph_duplicate': { type: "Dictionary" , properties: Dictionary };
  'input/ui_home': { type: "Dictionary" , properties: Dictionary };
  'input/ui_left': { type: "Dictionary" , properties: Dictionary };
  'input/ui_menu': { type: "Dictionary" , properties: Dictionary };
  'input/ui_page_down': { type: "Dictionary" , properties: Dictionary };
  'input/ui_page_up': { type: "Dictionary" , properties: Dictionary };
  'input/ui_paste': { type: "Dictionary" , properties: Dictionary };
  'input/ui_redo': { type: "Dictionary" , properties: Dictionary };
  'input/ui_right': { type: "Dictionary" , properties: Dictionary };
  'input/ui_select': { type: "Dictionary" , properties: Dictionary };
  'input/ui_swap_input_direction': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_add_selection_for_next_occurrence': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_backspace': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_backspace_all_to_left': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_backspace_all_to_left.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_backspace_word': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_backspace_word.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_add_above': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_add_above.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_add_below': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_add_below.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_document_end': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_document_end.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_document_start': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_document_start.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_down': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_left': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_line_end': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_line_end.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_line_start': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_line_start.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_page_down': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_page_up': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_right': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_up': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_word_left': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_word_left.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_word_right': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_caret_word_right.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_clear_carets_and_selection': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_completion_accept': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_completion_query': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_completion_replace': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_dedent': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_delete': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_delete_all_to_right': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_delete_all_to_right.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_delete_word': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_delete_word.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_indent': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_newline': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_newline_above': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_newline_blank': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_scroll_down': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_scroll_down.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_scroll_up': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_scroll_up.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_select_all': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_select_word_under_caret': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_select_word_under_caret.macos': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_skip_selection_for_next_occurrence': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_submit': { type: "Dictionary" , properties: Dictionary };
  'input/ui_text_toggle_insert_mode': { type: "Dictionary" , properties: Dictionary };
  'input/ui_undo': { type: "Dictionary" , properties: Dictionary };
  'input/ui_unicode_start': { type: "Dictionary" , properties: Dictionary };
  'input/ui_up': { type: "Dictionary" , properties: Dictionary };
...
export interface TextEdit extends Control {
  ...
  structured_text_bidi_override: type.int;
  structured_text_bidi_override_options: type.Array;
  syntax_highlighter: { type: "SyntaxHighlighter" , properties: SyntaxHighlighter };
  text: type.String;
  text_direction: type.int;
...
export namespace TextEdit {export const enum MenuItems {
  MENU_CUT = 0,
  MENU_COPY = 1,
  MENU_PASTE = 2,
  MENU_CLEAR = 3,
...
export const enum LineWrappingMode {
...
export interface TileMap extends Node2D {
  ...
  tile_set: { type: "TileSet" , properties: TileSet };  
}

export namespace TileMap {export const enum VisibilityMode {
...
export namespace VisualShaderNodeLinearSceneDepth {
}
...
export namespace TextureCubemapArrayRD {
}
...
export namespace SubViewportContainer {
}
...
export namespace VisualShaderNodeParticleRandomness {export const enum OpType {
  OP_TYPE_SCALAR = 0,
  OP_TYPE_VECTOR_2D = 1,
  OP_TYPE_VECTOR_3D = 2,
  OP_TYPE_VECTOR_4D = 3,
...
export namespace CompressedTexture2DArray {
}


export interface CanvasLayer extends Node {
  custom_viewport: { type: "Node" , properties: Node };
...
export namespace ConvexPolygonShape3D {
}


export interface CanvasTexture extends Texture2D {
  diffuse_texture: { type: "Texture2D" , properties: Texture2D };
  normal_texture: { type: "Texture2D" , properties: Texture2D };
  resource_local_to_scene: type.bool;
  specular_color: type.Color;
  specular_shininess: type.float;
  specular_texture: { type: "Texture2D" , properties: Texture2D };
  texture_filter: type.int;
...
export namespace EditorInspectorPlugin {
}
...
export namespace NavigationServer3D {export const enum ProcessInfo {
  INFO_ACTIVE_MAPS = 0,
  INFO_REGION_COUNT = 1,
  INFO_AGENT_COUNT = 2,
  INFO_LINK_COUNT = 3,
...
export namespace VisualShaderNodeVectorFunc {export const enum Function {
  FUNC_NORMALIZE = 0,
  FUNC_SATURATE = 1,
  FUNC_NEGATE = 2,
  FUNC_RECIPROCAL = 3,
...
export namespace TileMapPattern {
}
...
export namespace NavigationLink2D {
}
...
export namespace VisualShaderNodeUIntOp {export const enum Operator {
  OP_ADD = 0,
  OP_SUB = 1,
  OP_MUL = 2,
  OP_DIV = 3,
...
export namespace VisualShaderNodeStep {export const enum OpType {
  OP_TYPE_SCALAR = 0,
  OP_TYPE_VECTOR_2D = 1,
...
export interface LightmapGIData extends Resource {
  light_texture: { type: "TextureLayered" , properties: TextureLayered };
  lightmap_textures: { type: "TextureLayered[]" , properties: TextureLayered[] };  
}

export namespace LightmapGIData {
}
...
export const NOTIFICATION_PRE_SORT_CHILDREN = 50;
export const NOTIFICATION_SORT_CHILDREN = 51;
}
...
export namespace CallbackTweener {
}
...
export namespace ImageTexture3D {
}
...
export namespace VisualShaderNodeRotationByAxis {
}
...
export namespace GridContainer {
}


export interface World3D extends Resource {
  camera_attributes: { type: "CameraAttributes" , properties: CameraAttributes };
  direct_space_state: { type: "PhysicsDirectSpaceState3D" , properties: PhysicsDirectSpaceState3D };
  environment: { type: "Environment" , properties: Environment };
  fallback_environment: { type: "Environment" , properties: Environment };
  navigation_map: { type: "RID" , properties: RID };
  scenario: { type: "RID" , properties: RID };
  space: { type: "RID" , properties: RID };  
}

export namespace World3D {
}
...
export namespace InputEventMouseButton {
}
...
export interface PanoramaSkyMaterial extends Material {
  ...
  filter: type.bool;
  panorama: { type: "Texture2D" , properties: Texture2D };  
}

export namespace PanoramaSkyMaterial {
}
...
export namespace PhysicsDirectSpaceState2D {
}
...
export namespace CanvasItemMaterial {export const enum BlendMode {
  BLEND_MODE_MIX = 0,
  BLEND_MODE_ADD = 1,
  BLEND_MODE_SUB = 2,
  BLEND_MODE_MUL = 3,
...
export namespace SeparationRayShape3D {
}
...
export namespace CollisionPolygon3D {
}
...
export namespace InputEventPanGesture {
}
...
export namespace StreamPeerBuffer {
}
...
export interface StaticBody3D extends PhysicsBody3D {
  ...
  physics_material_override: { type: "PhysicsMaterial" , properties: PhysicsMaterial };  
}

export namespace StaticBody3D {
}
...
export namespace EditorFileDialog {export const enum FileMode {
...
export namespace VisualShaderNodeVec2Parameter {
}
...
export namespace EditorNode3DGizmo {
}
...
export namespace RenderSceneData {
}


export interface Camera3D extends Node3D {
  attributes: { type: "CameraAttributes" , properties: CameraAttributes };
  compositor: { type: "Compositor" , properties: Compositor };
  cull_mask: type.int;
  current: type.bool;
  doppler_tracking: type.int;
  environment: { type: "Environment" , properties: Environment };
...
export namespace Camera3D {export const enum ProjectionType {
  PROJECTION_PERSPECTIVE = 0,
  PROJECTION_ORTHOGONAL = 1,
  PROJECTION_FRUSTUM = 2,
}

export const enum KeepAspect {
  KEEP_WIDTH = 0,
  KEEP_HEIGHT = 1,
}
...
export namespace VisualShaderNodeUIntFunc {export const enum Function {
  FUNC_NEGATE = 0,
  FUNC_BITWISE_NOT = 1,
  FUNC_MAX = 2,
}
...
export namespace RenderSceneBuffers {
}
...
export namespace ConcavePolygonShape3D {
}
...
export namespace WorldBoundaryShape3D {
}
...
export namespace PhysicsTestMotionResult3D {
}
...
export namespace VisualShaderNodeParticleEmitter {
}
...
export namespace VFlowContainer {
}
...
export namespace AnimatableBody3D {
}
...
export interface FogMaterial extends Material {
  albedo: type.Color;
  density: type.float;
  density_texture: { type: "Texture3D" , properties: Texture3D };
  edge_fade: type.float;
  emission: type.Color;
  height_falloff: type.float;  
}

export namespace FogMaterial {
}
...
export namespace RootMotionView {
}
...
export interface PhysicsShapeQueryParameters3D extends RefCounted {
  ...
  exclude: { type: "RID[]" , properties: RID[] };
  margin: type.float;
  motion: type.Vector3;
  shape: { type: "Resource" , properties: Resource };
  shape_rid: { type: "RID" , properties: RID };
  transform: type.Transform3D;  
}

export namespace PhysicsShapeQueryParameters3D {
}
...
export namespace AudioStreamPlaybackPolyphonic {
export const INVALID_ID = -1;
}
...
export namespace VisualShaderNodeTexture3DParameter {
}
...
export namespace AudioEffectHighPassFilter {
}
...
export namespace VisualShaderNodeParticleEmit {export const enum EmitFlags {
...
export namespace ResourceImporterBitMap {
}
...
export namespace LinkButton {export const enum UnderlineMode {
...
export namespace PhysicsShapeQueryParameters2D {
}


export interface ThemeDB extends Object {
  fallback_base_scale: type.float;
  fallback_font: { type: "Font" , properties: Font };
  fallback_font_size: type.int;
  fallback_icon: { type: "Texture2D" , properties: Texture2D };
  fallback_stylebox: { type: "StyleBox" , properties: StyleBox };  
}

export namespace ThemeDB {
}
...
export namespace StreamPeerTCP {export const enum Status {
  STATUS_NONE = 0,
  STATUS_CONNECTING = 1,
  STATUS_CONNECTED = 2,
  STATUS_ERROR = 3,
...
export namespace XRFaceTracker {export const enum BlendShapeEntry {
...
export namespace AnimatableBody2D {
}
...
export namespace MultiMesh {export const enum TransformFormat {
  TRANSFORM_2D = 0,
  TRANSFORM_3D = 1,
}

export const enum PhysicsInterpolationQuality {
...
export namespace VisualInstance3D {
}
...
export namespace WorldBoundaryShape2D {
}
...
export namespace FramebufferCacheRD {
}
...
export namespace PhysicsTestMotionResult2D {
}
...
export namespace LabelSettings {
}
...
export namespace ConcavePolygonShape2D {
}
...
export namespace Camera2D {export const enum AnchorMode {
  ANCHOR_MODE_FIXED_TOP_LEFT = 0,
  ANCHOR_MODE_DRAG_CENTER = 1,
}

export const enum Camera2DProcessCallback {
...
export namespace PacketPeerUDP {
}
...
export interface LightmapGI extends VisualInstance3D {
  ...
  environment_custom_sky: { type: "Sky" , properties: Sky };
  environment_mode: type.int;
  generate_probes_subdiv: type.int;
  interior: type.bool;
  light_data: { type: "LightmapGIData" , properties: LightmapGIData };
...
export namespace LightmapGI {export const enum BakeQuality {
  BAKE_QUALITY_LOW = 0,
...
export const enum GenerateProbes {
...
export namespace AStarGrid2D {export const enum Heuristic {
...
export const enum DiagonalMode {
...
export namespace Time {export const enum Month {
  MONTH_JANUARY = 1,
  MONTH_FEBRUARY = 2,
  MONTH_MARCH = 3,
  MONTH_APRIL = 4,
...
export namespace VisualShaderNodeTransformVecMult {export const enum Operator {
  OP_AxB = 0,
  OP_BxA = 1,
  OP_3x3_AxB = 2,
  OP_3x3_BxA = 3,
...
export namespace VehicleBody3D {
}
...
export namespace AudioStreamRandomizer {export const enum PlaybackMode {
...
export namespace PhysicsDirectSpaceState3DExtension {
}
...
export namespace VisualShaderNodeOutput {
}
...
export namespace VisualShaderNodeParameterRef {
}
...
export namespace AudioEffectStereoEnhance {
}
...
export namespace ResourceImporterImageFont {
}
...
export namespace PhysicsMaterial {
}
...
export namespace AudioEffectPhaser {
}
...
export namespace VisualShaderNodeReroute {
}
...
export namespace VisualShaderNodeSwitch {export const enum OpType {
  OP_TYPE_FLOAT = 0,
  OP_TYPE_INT = 1,
  OP_TYPE_UINT = 2,
  OP_TYPE_VECTOR_2D = 3,
...
export namespace NativeMenu {export const enum Feature {
...
export namespace SeparationRayShape2D {
}
...
export namespace XRBodyTracker {export const enum BodyFlags {
...
export namespace CollisionPolygon2D {export const enum BuildMode {
  BUILD_SOLIDS = 0,
  BUILD_SEGMENTS = 1,
}
...
export namespace AudioEffectLimiter {
}
...
export namespace PhysicsDirectSpaceState3D {
}
...
export interface World2D extends Resource {
  canvas: { type: "RID" , properties: RID };
  direct_space_state: { type: "PhysicsDirectSpaceState2D" , properties: PhysicsDirectSpaceState2D };
  navigation_map: { type: "RID" , properties: RID };
  space: { type: "RID" , properties: RID };  
}
...
export namespace InputEventGesture {
}
...
export namespace VBoxContainer {
}
...
export namespace AudioStreamGeneratorPlayback {
}
...
export namespace HTTPRequest {export const enum Result {
  RESULT_SUCCESS = 0,
...
export namespace VisualShaderNodeVec3Constant {
}


export interface VisualShaderNodeTexture2DArray extends VisualShaderNodeSample3D {
  texture_array: { type: "TextureLayered" , properties: TextureLayered };  
}

export namespace VisualShaderNodeTexture2DArray {
}
...
export namespace AnimationNodeBlendSpace2D {export const enum BlendMode {
...
export namespace AnimationNodeOutput {
}
...
export interface GeometryInstance3D extends VisualInstance3D {
  ...
  lod_bias: type.float;
  material_overlay: { type: "Material" , properties: Material };
  material_override: { type: "Material" , properties: Material };
...
export namespace GeometryInstance3D {export const enum ShadowCastingSetting {
...
export const enum GIMode {
  GI_MODE_DISABLED = 0,
  GI_MODE_STATIC = 1,
  GI_MODE_DYNAMIC = 2,
}

export const enum LightmapScale {
  LIGHTMAP_SCALE_1X = 0,
  LIGHTMAP_SCALE_2X = 1,
  LIGHTMAP_SCALE_4X = 2,
  LIGHTMAP_SCALE_8X = 3,
...
export const enum VisibilityRangeFadeMode {
...
export const NOTIFICATION_VISIBILITY_CHANGED = 43;
export const NOTIFICATION_LOCAL_TRANSFORM_CHANGED = 44;
export const enum RotationEditMode {
...
export namespace VisualShader {export const enum Type {
  TYPE_VERTEX = 0,
  TYPE_FRAGMENT = 1,
  TYPE_LIGHT = 2,
  TYPE_START = 3,
...
export const NODE_ID_INVALID = -1;
export const NODE_ID_OUTPUT = 0;
}


export interface Compositor extends Resource {
  compositor_effects: { type: "CompositorEffect[]" , properties: CompositorEffect[] };  
}
...
export namespace VisualShaderNodeVec4Parameter {
}
...
export namespace VisualShaderNodeColorFunc {export const enum Function {
  FUNC_GRAYSCALE = 0,
  FUNC_HSV2RGB = 1,
  FUNC_RGB2HSV = 2,
  FUNC_SEPIA = 3,
...
export namespace NavigationLink3D {
}
...
export namespace VisualShaderNodeVec3Parameter {
}
...
export namespace ConvexPolygonShape2D {
}
...
export namespace NavigationServer2D {
}


export interface JSON extends Resource {
  data: { type: "Variant" , properties: Variant };  
}
...
export namespace MultiplayerPeer {export const enum ConnectionStatus {
...
export const TARGET_PEER_BROADCAST = 0;
export const TARGET_PEER_SERVER = 1;
...
export namespace AudioEffectAmplify {
}
...
export namespace ScriptExtension {
}
...
export namespace InputEventMagnifyGesture {
}
...
export namespace AudioEffectEQ10 {
}


export interface VisualShaderNodeTexture3D extends VisualShaderNodeSample3D {
  texture: { type: "Texture3D" , properties: Texture3D };  
}

export namespace VisualShaderNodeTexture3D {
}
...
export interface TextureButton extends BaseButton {
  ...
  texture_click_mask: { type: "BitMap" , properties: BitMap };
  texture_disabled: { type: "Texture2D" , properties: Texture2D };
  texture_focused: { type: "Texture2D" , properties: Texture2D };
  texture_hover: { type: "Texture2D" , properties: Texture2D };
  texture_normal: { type: "Texture2D" , properties: Texture2D };
  texture_pressed: { type: "Texture2D" , properties: Texture2D };  
}

export namespace TextureButton {export const enum StretchMode {
  STRETCH_SCALE = 0,
  STRETCH_TILE = 1,
  STRETCH_KEEP = 2,
...
export namespace XRInterface {export const enum Capabilities {
  XR_NONE = 0,
  XR_MONO = 1,
  XR_STEREO = 2,
  XR_QUAD = 4,
...
export const enum PlayAreaMode {
...
export const enum EnvironmentBlendMode {
...
export namespace SkeletonIK3D {
}


export interface MultiplayerAPI extends RefCounted {
  multiplayer_peer: { type: "MultiplayerPeer" , properties: MultiplayerPeer };  
}

export namespace MultiplayerAPI {export const enum RPCMode {
  RPC_MODE_DISABLED = 0,
  RPC_MODE_ANY_PEER = 1,
...
export namespace AudioStreamPlayer2D {
}
...
export namespace VisualShaderNodeParticleMultiplyByAxisAngle {
}
...
export namespace VisualShaderNodeFrame {
}


export interface VoxelGI extends VisualInstance3D {
  camera_attributes: { type: "CameraAttributes" , properties: CameraAttributes };
  data: { type: "VoxelGIData" , properties: VoxelGIData };
  size: type.Vector3;
  subdiv: type.int;  
}

export namespace VoxelGI {export const enum Subdiv {
  SUBDIV_64 = 0,
  SUBDIV_128 = 1,
  SUBDIV_256 = 2,
  SUBDIV_512 = 3,
...
export namespace VisualShaderNodeInput {
}
...
export namespace VisualShaderNodeParticleMeshEmitter {
}
...
export namespace ScriptEditorBase {
}
...
export namespace EditorTranslationParserPlugin {
}
...
export namespace RectangleShape2D {
}
...
export namespace MeshInstance2D {
}
...
export namespace NinePatchRect {export const enum AxisStretchMode {
...
export namespace FileAccess {export const enum ModeFlags {
  READ = 1,
  WRITE = 2,
  READ_WRITE = 3,
  WRITE_READ = 7,
...
export const enum UnixPermissionFlags {
  UNIX_READ_OWNER = 256,
...
export namespace PhysicsBody2D {
}


export interface VisualShaderNodeCurveTexture extends VisualShaderNodeResizableBase {
  texture: { type: "CurveTexture" , properties: CurveTexture };  
}

export namespace VisualShaderNodeCurveTexture {
}
...
export namespace OptimizedTranslation {
}
...
export namespace RDTextureView {
}
...
export interface Light3D extends VisualInstance3D {
  ...
  light_projector: { type: "Texture2D" , properties: Texture2D };
...
export namespace Light3D {export const enum Param {
  PARAM_ENERGY = 0,
...
export interface PhysicsTestMotionParameters2D extends RefCounted {
  ...
  exclude_bodies: { type: "RID[]" , properties: RID[] };
  exclude_objects: { type: "int[]" , properties: int[] };
...
export namespace PhysicsTestMotionParameters2D {
}
...
export namespace PhysicsServer3DManager {
}
...
export interface AnimatedSprite2D extends Node2D {
  ...
  sprite_frames: { type: "SpriteFrames" , properties: SpriteFrames };  
}

export namespace AnimatedSprite2D {
}
...
export namespace VisualShaderNodeIf {
}
...
export namespace AudioEffectCompressor {
}
...
export namespace RDPipelineColorBlendStateAttachment {
}
...
export namespace HFlowContainer {
}
...
export namespace VisualShaderNodeMix {export const enum OpType {
  OP_TYPE_SCALAR = 0,
  OP_TYPE_VECTOR_2D = 1,
  OP_TYPE_VECTOR_2D_SCALAR = 2,
  OP_TYPE_VECTOR_3D = 3,
...
export const DEVICE_ID_EMULATION = -1;
}
...
export namespace CircleShape2D {
}
...
export namespace XRBodyModifier3D {export const enum BodyUpdate {
  BODY_UPDATE_UPPER_BODY = 1,
  BODY_UPDATE_LOWER_BODY = 2,
  BODY_UPDATE_HANDS = 4,
}

export const enum BoneUpdate {
  BONE_UPDATE_FULL = 0,
...
export namespace ClassDB {export const enum APIType {
  API_CORE = 0,
  API_EDITOR = 1,
  API_EXTENSION = 2,
...
export namespace AnimationNodeStateMachine {export const enum StateMachineType {
...
export namespace AudioEffectEQ {
}
...
export namespace ResourceImporterTextureAtlas {
}
...
export namespace KinematicCollision2D {
}
...
export namespace VisualShaderNodeVectorRefract {
}
...
export namespace SkeletonModification2DPhysicalBones {
}
...
export namespace PhysicsDirectBodyState3D {
}
...
export namespace Area2D {export const enum SpaceOverride {
...
export namespace VisualShaderNodeIntParameter {export const enum Hint {
  HINT_NONE = 0,
  HINT_RANGE = 1,
  HINT_RANGE_STEP = 2,
  HINT_ENUM = 3,
...
export namespace SkeletonModification2DJiggle {
}
...
export const NOTIFICATION_MOUSE_ENTER_SELF = 60;
export const NOTIFICATION_MOUSE_EXIT_SELF = 61;
...
export const NOTIFICATION_LAYOUT_DIRECTION_CHANGED = 49;
...
export const enum LayoutPreset {
  PRESET_TOP_LEFT = 0,
  PRESET_TOP_RIGHT = 1,
...
export const enum LayoutPresetMode {
...
export namespace VisualShaderNodeFloatOp {export const enum Operator {
  OP_ADD = 0,
  OP_SUB = 1,
  OP_MUL = 2,
  OP_DIV = 3,
...
export namespace AnimationTree {export const enum AnimationProcessCallback {
...
export namespace ScriptLanguage {export const enum ScriptNameCasing {
...
export interface VisualShaderNodeCurveXYZTexture extends VisualShaderNodeResizableBase {
  texture: { type: "CurveXYZTexture" , properties: CurveXYZTexture };  
}

export namespace VisualShaderNodeCurveXYZTexture {
}
...
export namespace GPUParticlesAttractorVectorField3D {
}
...
export namespace XRPositionalTracker {export const enum TrackerHand {
...
export namespace NavigationMeshGenerator {
}
...
export namespace Skeleton3D {
export const NOTIFICATION_UPDATE_SKELETON = 50;
export const enum ModifierCallbackModeProcess {
...
export namespace VisualShaderNodeUVPolarCoord {
}
...
export namespace VisualShaderNodeFloatFunc {export const enum Function {
  FUNC_SIN = 0,
  FUNC_COS = 1,
  FUNC_TAN = 2,
  FUNC_ASIN = 3,
...
export namespace InputEventMouseMotion {
}


export interface Path3D extends Node3D {
  curve: { type: "Curve3D" , properties: Curve3D };  
}

export namespace Path3D {
}
...
export interface Line2D extends Node2D {
  ...
  gradient: { type: "Gradient" , properties: Gradient };
  joint_mode: type.int;
  points: type.PackedVector2Array;
  ...
  width: type.float;
  width_curve: { type: "Curve" , properties: Curve };  
}

export namespace Line2D {export const enum LineJointMode {
  LINE_JOINT_SHARP = 0,
  LINE_JOINT_BEVEL = 1,
  LINE_JOINT_ROUND = 2,
}
...
export const enum LineTextureMode {
  LINE_TEXTURE_NONE = 0,
  LINE_TEXTURE_TILE = 1,
...
export namespace GPUParticlesCollisionHeightField3D {export const enum Resolution {
  RESOLUTION_256 = 0,
  RESOLUTION_512 = 1,
  RESOLUTION_1024 = 2,
  RESOLUTION_2048 = 3,
...
export interface Label extends Control {
  ...
  horizontal_alignment: type.int;
  justification_flags: type.int;
  label_settings: { type: "LabelSettings" , properties: LabelSettings };
  language: type.String;
...
export namespace EngineProfiler {
}
...
export namespace CharacterBody3D {export const enum MotionMode {
  MOTION_MODE_GROUNDED = 0,
  MOTION_MODE_FLOATING = 1,
}

export const enum PlatformOnLeave {
...
export namespace CanvasModulate {
}
...
export namespace RDShaderSource {
}
...
export namespace CameraAttributes {
}
...
export namespace EditorNode3DGizmoPlugin {
}
...
export namespace PhysicsPointQueryParameters2D {
}
...
export namespace PlaceholderMaterial {
}
...
export namespace AudioEffectHardLimiter {
}
...
export namespace VisualShaderNode {export const enum PortType {
  PORT_TYPE_SCALAR = 0,
...
export namespace Animation {export const enum TrackType {
  TYPE_VALUE = 0,
  TYPE_POSITION_3D = 1,
  TYPE_ROTATION_3D = 2,
  TYPE_SCALE_3D = 3,
...
export namespace ResourceFormatLoader {export const enum CacheMode {
  CACHE_MODE_IGNORE = 0,
  CACHE_MODE_REUSE = 1,
...
export namespace PhysicsDirectBodyState2DExtension {
}
...
export namespace StyleBoxFlat {
}


export interface CPUParticles3D extends GeometryInstance3D {
  amount: type.int;
  angle_curve: { type: "Curve" , properties: Curve };
  angle_max: type.float;
  angle_min: type.float;
  angular_velocity_curve: { type: "Curve" , properties: Curve };
  angular_velocity_max: type.float;
  angular_velocity_min: type.float;
  anim_offset_curve: { type: "Curve" , properties: Curve };
  anim_offset_max: type.float;
  anim_offset_min: type.float;
  anim_speed_curve: { type: "Curve" , properties: Curve };
  anim_speed_max: type.float;
  anim_speed_min: type.float;
  color: type.Color;
  color_initial_ramp: { type: "Gradient" , properties: Gradient };
  color_ramp: { type: "Gradient" , properties: Gradient };
  damping_curve: { type: "Curve" , properties: Curve };
  damping_max: type.float;
  damping_min: type.float;
  direction: type.Vector3;
  draw_order: type.int;
  ...
  gravity: type.Vector3;
  hue_variation_curve: { type: "Curve" , properties: Curve };
  hue_variation_max: type.float;
  hue_variation_min: type.float;
  initial_velocity_max: type.float;
  initial_velocity_min: type.float;
  lifetime: type.float;
  lifetime_randomness: type.float;
  linear_accel_curve: { type: "Curve" , properties: Curve };
  linear_accel_max: type.float;
  linear_accel_min: type.float;
  local_coords: type.bool;
  mesh: { type: "Mesh" , properties: Mesh };
  one_shot: type.bool;
  orbit_velocity_curve: { type: "Curve" , properties: Curve };
  orbit_velocity_max: type.float;
  orbit_velocity_min: type.float;
  particle_flag_align_y: type.bool;
  particle_flag_disable_z: type.bool;
  ...
  radial_accel_curve: { type: "Curve" , properties: Curve };
  radial_accel_max: type.float;
  radial_accel_min: type.float;
  randomness: type.float;
  scale_amount_curve: { type: "Curve" , properties: Curve };
  scale_amount_max: type.float;
  scale_amount_min: type.float;
  scale_curve_x: { type: "Curve" , properties: Curve };
  scale_curve_y: { type: "Curve" , properties: Curve };
  scale_curve_z: { type: "Curve" , properties: Curve };
  speed_scale: type.float;
  split_scale: type.bool;
  spread: type.float;
  tangential_accel_curve: { type: "Curve" , properties: Curve };
  tangential_accel_max: type.float;
  tangential_accel_min: type.float;
  visibility_aabb: type.AABB;  
}

export namespace CPUParticles3D {export const enum DrawOrder {
  DRAW_ORDER_INDEX = 0,
...
export namespace SceneState {export const enum GenEditState {
...
export namespace PhysicsServer2DExtension {
}
...
export namespace VisualShaderNodeResizableBase {
}
...
export namespace UniformSetCacheRD {
}
...
export namespace PlaceholderMesh {
}
...
export namespace PhysicalBone2D {
}
...
export namespace ResourceImporterLayeredTexture {
}
...
export namespace VisualShaderNodeVectorOp {export const enum Operator {
  OP_ADD = 0,
  OP_SUB = 1,
  OP_MUL = 2,
  OP_DIV = 3,
...
export namespace GradientTexture2D {export const enum Fill {
  FILL_LINEAR = 0,
  FILL_RADIAL = 1,
  FILL_SQUARE = 2,
}
...
export namespace GPUParticles2D {export const enum DrawOrder {
  DRAW_ORDER_INDEX = 0,
  DRAW_ORDER_LIFETIME = 1,
...
export namespace RDPipelineRasterizationState {
}
...
export namespace CompressedTexture2D {
}
...
export namespace AudioEffectCapture {
}
...
export namespace VisualShaderNodeVaryingGetter {
}
...
export namespace VisualShaderNodeSDFToScreenUV {
}
...
export namespace MultiplayerAPIExtension {
}
...
export namespace VisualShaderNodeVectorDistance {
}


export interface Theme extends Resource {
  default_base_scale: type.float;
  default_font: { type: "Font" , properties: Font };
  default_font_size: type.int;  
}

export namespace Theme {export const enum DataType {
  DATA_TYPE_COLOR = 0,
...
export namespace AudioEffectSpectrumAnalyzer {export const enum FFTSize {
  FFT_SIZE_256 = 0,
  FFT_SIZE_512 = 1,
  FFT_SIZE_1024 = 2,
  FFT_SIZE_2048 = 3,
...
export namespace InputEventKey {
}
...
export namespace VisualShaderNodeFloatParameter {export const enum Hint {
  HINT_NONE = 0,
  HINT_RANGE = 1,
  HINT_RANGE_STEP = 2,
  HINT_MAX = 3,
...
export namespace ORMMaterial3D {
}
...
export namespace RenderingServer {
...
export const MAX_MESH_SURFACES = 256;
export const MATERIAL_RENDER_PRIORITY_MIN = -128;
export const MATERIAL_RENDER_PRIORITY_MAX = 127;
export const ARRAY_CUSTOM_COUNT = 4;
export const PARTICLES_EMIT_FLAG_POSITION = 1;
export const PARTICLES_EMIT_FLAG_ROTATION_SCALE = 2;
export const PARTICLES_EMIT_FLAG_VELOCITY = 4;
export const PARTICLES_EMIT_FLAG_COLOR = 8;
export const PARTICLES_EMIT_FLAG_CUSTOM = 16;
...
export const enum TextureLayeredType {
  TEXTURE_LAYERED_2D_ARRAY = 0,
  TEXTURE_LAYERED_CUBEMAP = 1,
  TEXTURE_LAYERED_CUBEMAP_ARRAY = 2,
}

export const enum CubeMapLayer {
...
export const enum MultimeshTransformFormat {
  MULTIMESH_TRANSFORM_2D = 0,
  MULTIMESH_TRANSFORM_3D = 1,
}

export const enum MultimeshPhysicsInterpolationQuality {
  MULTIMESH_INTERP_QUALITY_FAST = 0,
  MULTIMESH_INTERP_QUALITY_HIGH = 1,
}

export const enum LightProjectorFilter {
...
export const enum LightBakeMode {
  LIGHT_BAKE_DISABLED = 0,
  LIGHT_BAKE_STATIC = 1,
  LIGHT_BAKE_DYNAMIC = 2,
}

export const enum LightOmniShadowMode {
  LIGHT_OMNI_SHADOW_DUAL_PARABOLOID = 0,
  LIGHT_OMNI_SHADOW_CUBE = 1,
}

export const enum LightDirectionalShadowMode {
  LIGHT_DIRECTIONAL_SHADOW_ORTHOGONAL = 0,
  LIGHT_DIRECTIONAL_SHADOW_PARALLEL_2_SPLITS = 1,
  LIGHT_DIRECTIONAL_SHADOW_PARALLEL_4_SPLITS = 2,
}

export const enum LightDirectionalSkyMode {
...
export const enum ReflectionProbeUpdateMode {
  REFLECTION_PROBE_UPDATE_ONCE = 0,
  REFLECTION_PROBE_UPDATE_ALWAYS = 1,
}

export const enum ReflectionProbeAmbientMode {
  REFLECTION_PROBE_AMBIENT_DISABLED = 0,
  REFLECTION_PROBE_AMBIENT_ENVIRONMENT = 1,
  REFLECTION_PROBE_AMBIENT_COLOR = 2,
}

export const enum DecalTexture {
...
export const enum VoxelGIQuality {
  VOXEL_GI_QUALITY_LOW = 0,
  VOXEL_GI_QUALITY_HIGH = 1,
}

export const enum ParticlesMode {
  PARTICLES_MODE_2D = 0,
  PARTICLES_MODE_3D = 1,
}

export const enum ParticlesTransformAlign {
...
export const enum ParticlesDrawOrder {
...
export const enum ParticlesCollisionType {
...
export const enum ParticlesCollisionHeightfieldResolution {
...
export const enum FogVolumeShape {
...
export const enum ViewportScaling3DMode {
...
export const enum ViewportUpdateMode {
...
export const enum ViewportClearMode {
  VIEWPORT_CLEAR_ALWAYS = 0,
  VIEWPORT_CLEAR_NEVER = 1,
  VIEWPORT_CLEAR_ONLY_NEXT_FRAME = 2,
}

export const enum ViewportEnvironmentMode {
...
export const enum ViewportSDFOversize {
...
export const enum ViewportSDFScale {
...
export const enum ViewportMSAA {
...
export const enum ViewportScreenSpaceAA {
  VIEWPORT_SCREEN_SPACE_AA_DISABLED = 0,
  VIEWPORT_SCREEN_SPACE_AA_FXAA = 1,
  VIEWPORT_SCREEN_SPACE_AA_MAX = 2,
}

export const enum ViewportOcclusionCullingBuildQuality {
  VIEWPORT_OCCLUSION_BUILD_QUALITY_LOW = 0,
  VIEWPORT_OCCLUSION_BUILD_QUALITY_MEDIUM = 1,
  VIEWPORT_OCCLUSION_BUILD_QUALITY_HIGH = 2,
}

export const enum ViewportRenderInfo {
...
export const enum ViewportRenderInfoType {
...
export const enum ViewportDebugDraw {
...
export const enum ViewportVRSMode {
...
export const enum ViewportVRSUpdateMode {
...
export const enum CompositorEffectFlags {
...
export const enum CompositorEffectCallbackType {
...
export const enum EnvironmentBG {
...
export const enum EnvironmentAmbientSource {
...
export const enum EnvironmentReflectionSource {
  ENV_REFLECTION_SOURCE_BG = 0,
  ENV_REFLECTION_SOURCE_DISABLED = 1,
  ENV_REFLECTION_SOURCE_SKY = 2,
}

export const enum EnvironmentGlowBlendMode {
...
export const enum EnvironmentFogMode {
  ENV_FOG_MODE_EXPONENTIAL = 0,
  ENV_FOG_MODE_DEPTH = 1,
}

export const enum EnvironmentToneMapper {
...
export const enum EnvironmentSSRRoughnessQuality {
...
export const enum EnvironmentSSAOQuality {
...
export const enum EnvironmentSSILQuality {
...
export const enum EnvironmentSDFGIFramesToConverge {
...
export const enum EnvironmentSDFGIFramesToUpdateLight {
...
export const enum SubSurfaceScatteringQuality {
...
export const enum DOFBokehShape {
  DOF_BOKEH_BOX = 0,
  DOF_BOKEH_HEXAGON = 1,
  DOF_BOKEH_CIRCLE = 2,
}

export const enum DOFBlurQuality {
...
export const enum ShadowCastingSetting {
  SHADOW_CASTING_SETTING_OFF = 0,
  SHADOW_CASTING_SETTING_ON = 1,
  SHADOW_CASTING_SETTING_DOUBLE_SIDED = 2,
  SHADOW_CASTING_SETTING_SHADOWS_ONLY = 3,
...
export const enum BakeChannels {
...
export const enum CanvasTextureChannel {
  CANVAS_TEXTURE_CHANNEL_DIFFUSE = 0,
  CANVAS_TEXTURE_CHANNEL_NORMAL = 1,
  CANVAS_TEXTURE_CHANNEL_SPECULAR = 2,
}

export const enum NinePatchAxisMode {
  NINE_PATCH_STRETCH = 0,
  NINE_PATCH_TILE = 1,
  NINE_PATCH_TILE_FIT = 2,
}

export const enum CanvasItemTextureFilter {
...
export const enum CanvasItemTextureRepeat {
...
export const enum CanvasGroupMode {
...
export const enum CanvasOccluderPolygonCullMode {
  CANVAS_OCCLUDER_POLYGON_CULL_DISABLED = 0,
  CANVAS_OCCLUDER_POLYGON_CULL_CLOCKWISE = 1,
  CANVAS_OCCLUDER_POLYGON_CULL_COUNTER_CLOCKWISE = 2,
}

export const enum GlobalShaderParameterType {
...
export const enum RenderingInfo {
...
export const enum PipelineSource {
...
export namespace ProgressBar {export const enum FillMode {
  FILL_BEGIN_TO_END = 0,
  FILL_END_TO_BEGIN = 1,
  FILL_TOP_TO_BOTTOM = 2,
  FILL_BOTTOM_TO_TOP = 3,
...
export namespace RichTextLabel {export const enum ListType {
  LIST_NUMBERS = 0,
  LIST_LETTERS = 1,
  LIST_ROMAN = 2,
  LIST_DOTS = 3,
...
export namespace VisualShaderNodeIs {export const enum Function {
  FUNC_IS_INF = 0,
  FUNC_IS_NAN = 1,
  FUNC_MAX = 2,
}
...
export namespace CapsuleShape3D {
}
...
export namespace VisualShaderNodeColorOp {export const enum Operator {
  OP_SCREEN = 0,
  OP_DIFFERENCE = 1,
  OP_DARKEN = 2,
  OP_LIGHTEN = 3,
...
export namespace JavaScriptBridge {
}
...
export interface CanvasItem extends Node {
  ...
  light_mask: type.int;
  material: { type: "Material" , properties: Material };
  modulate: type.Color;
...
export const enum ClipChildrenMode {
...
export namespace CylinderShape3D {
}
...
export namespace NavigationPolygon {export const enum SamplePartitionType {
  SAMPLE_PARTITION_CONVEX_PARTITION = 0,
  SAMPLE_PARTITION_TRIANGULATE = 1,
  SAMPLE_PARTITION_MAX = 2,
}

export const enum ParsedGeometryType {
...
export const enum SourceGeometryMode {
...
export namespace VisualShaderNodeRemap {export const enum OpType {
  OP_TYPE_SCALAR = 0,
  OP_TYPE_VECTOR_2D = 1,
  OP_TYPE_VECTOR_2D_SCALAR = 2,
  OP_TYPE_VECTOR_3D = 3,
...
export namespace AudioEffectNotchFilter {
}
...
export namespace PinJoint3D {export const enum Param {
  PARAM_BIAS = 0,
  PARAM_DAMPING = 1,
...
export interface SceneTree extends MainLoop {
  ...
  current_scene: { type: "Node" , properties: Node };
  debug_collisions_hint: type.bool;
  debug_navigation_hint: type.bool;
  debug_paths_hint: type.bool;
  edited_scene_root: { type: "Node" , properties: Node };
  multiplayer_poll: type.bool;
  paused: type.bool;
  physics_interpolation: type.bool;
  quit_on_go_back: type.bool;
  root: { type: "Window" , properties: Window };  
}

export namespace SceneTree {export const enum GroupCallFlags {
...
export namespace VisualShaderNodeParticleBoxEmitter {
}


export interface HTTPClient extends RefCounted {
  blocking_mode_enabled: type.bool;
  connection: { type: "StreamPeer" , properties: StreamPeer };
  read_chunk_size: type.int;  
}

export namespace HTTPClient {export const enum Method {
  METHOD_GET = 0,
  METHOD_HEAD = 1,
  METHOD_POST = 2,
  METHOD_PUT = 3,
...
export namespace EncodedObjectAsID {
}
...
export namespace EditorScenePostImportPlugin {export const enum InternalImportCategory {
...
export namespace CapsuleShape2D {
}
...
export namespace SurfaceTool {export const enum CustomFormat {
...
export const enum SkinWeightCount {
  SKIN_4_WEIGHTS = 0,
  SKIN_8_WEIGHTS = 1,
}
...
export namespace PortableCompressedTexture2D {export const enum CompressionMode {
...
export namespace VisualShaderNodeGroupBase {
}
...
export namespace OfflineMultiplayerPeer {
}
...
export namespace AnimationRootNode {
}
...
export namespace TileSetSource {
}
...
export const enum AnimationCallbackModeMethod {
  ANIMATION_CALLBACK_MODE_METHOD_DEFERRED = 0,
  ANIMATION_CALLBACK_MODE_METHOD_IMMEDIATE = 1,
}

export const enum AnimationCallbackModeDiscrete {
...
export namespace AnimationPlayer {export const enum AnimationProcessCallback {
  ANIMATION_PROCESS_PHYSICS = 0,
  ANIMATION_PROCESS_IDLE = 1,
  ANIMATION_PROCESS_MANUAL = 2,
}

export const enum AnimationMethodCallMode {
...
export namespace ArrayOccluder3D {
}
...
export namespace AnimationLibrary {
}
...
export namespace ImmediateMesh {
}


export interface EditorScriptPicker extends EditorResourcePicker {
  script_owner: { type: "Node" , properties: Node };  
}

export namespace EditorScriptPicker {
}
...
export namespace CompressedTexture3D {
}
...
export namespace StyleBoxTexture {export const enum AxisStretchMode {
  AXIS_STRETCH_MODE_STRETCH = 0,
  AXIS_STRETCH_MODE_TILE = 1,
  AXIS_STRETCH_MODE_TILE_FIT = 2,
}
...
export namespace VisualShaderNodeConstant {
}
...
export interface GPUParticles3D extends GeometryInstance3D {
  ...
  collision_base_size: type.float;
  draw_order: type.int;
  draw_pass_1: { type: "Mesh" , properties: Mesh };
  draw_pass_2: { type: "Mesh" , properties: Mesh };
  draw_pass_3: { type: "Mesh" , properties: Mesh };
  draw_pass_4: { type: "Mesh" , properties: Mesh };
  draw_passes: type.int;
  draw_skin: { type: "Skin" , properties: Skin };
  emitting: type.bool;
  explosiveness: type.float;
  fixed_fps: type.int;
  fract_delta: type.bool;
...
export namespace GPUParticles3D {export const enum DrawOrder {
  DRAW_ORDER_INDEX = 0,
  DRAW_ORDER_LIFETIME = 1,
  DRAW_ORDER_REVERSE_LIFETIME = 2,
...
export const MAX_DRAW_PASSES = 4;
export const enum TransformAlign {
...
export interface CodeHighlighter extends SyntaxHighlighter {
  color_regions: { type: "Dictionary" , properties: Dictionary };
  function_color: type.Color;
  keyword_colors: { type: "Dictionary" , properties: Dictionary };
  member_keyword_colors: { type: "Dictionary" , properties: Dictionary };
...
export namespace AnimationNode {export const enum FilterAction {
  FILTER_IGNORE = 0,
  FILTER_PASS = 1,
  FILTER_STOP = 2,
  FILTER_BLEND = 3,
...
export namespace VisualShaderNodeDeterminant {
}
...
export namespace RenderSceneDataRD {
}
...
export namespace VisualShaderNodeOuterProduct {
}
...
export namespace AudioEffectFilter {export const enum FilterDB {
  FILTER_6DB = 0,
  FILTER_12DB = 1,
  FILTER_18DB = 2,
  FILTER_24DB = 3,
...
export namespace AudioEffectHighShelfFilter {
}
...
export namespace CompositorEffect {export const enum EffectCallbackType {
...
export namespace PhysicalBone3D {export const enum DampMode {
  DAMP_MODE_COMBINE = 0,
  DAMP_MODE_REPLACE = 1,
}
...
export namespace VehicleWheel3D {
}
...
export namespace XRHandTracker {export const enum HandTrackingSource {
...
export const enum HandJointFlags {
...
export namespace AnimationNodeAnimation {export const enum PlayMode {
  PLAY_MODE_FORWARD = 0,
...
export namespace VisualShaderNodeIntConstant {
}
...
export namespace RenderDataExtension {
}
...
export namespace CPUParticles2D {export const enum DrawOrder {
  DRAW_ORDER_INDEX = 0,
  DRAW_ORDER_LIFETIME = 1,
}
...
export namespace CompressedTextureLayered {
}
...
export namespace ResourceImporterTexture {
}
...
export namespace AudioStreamMicrophone {
}
...
export namespace VisualShaderNodeMultiplyAdd {export const enum OpType {
  OP_TYPE_SCALAR = 0,
  OP_TYPE_VECTOR_2D = 1,
  OP_TYPE_VECTOR_3D = 2,
  OP_TYPE_VECTOR_4D = 3,
...
export namespace ReflectionProbe {export const enum UpdateMode {
  UPDATE_ONCE = 0,
  UPDATE_ALWAYS = 1,
}

export const enum AmbientMode {
  AMBIENT_DISABLED = 0,
...
export namespace FlowContainer {export const enum AlignmentMode {
  ALIGNMENT_BEGIN = 0,
  ALIGNMENT_CENTER = 1,
  ALIGNMENT_END = 2,
}

export const enum LastWrapAlignmentMode {
...
export namespace AudioBusLayout {
}
...
export namespace TileSetScenesCollectionSource {
}
...
export namespace MeshConvexDecompositionSettings {export const enum Mode {
...
export namespace VisualShaderNodeWorldPositionFromDepth {
}
...
export namespace PhysicsPointQueryParameters3D {
}
...
export namespace CharacterBody2D {export const enum MotionMode {
  MOTION_MODE_GROUNDED = 0,
  MOTION_MODE_FLOATING = 1,
}
...
export namespace VisualShaderNodeTransformCompose {
}
...
export namespace NavigationMesh {export const enum SamplePartitionType {
...
export namespace VisualShaderNodeVectorBase {export const enum OpType {
  OP_TYPE_VECTOR_2D = 0,
  OP_TYPE_VECTOR_3D = 1,
  OP_TYPE_VECTOR_4D = 2,
  OP_TYPE_MAX = 3,
...
export const NOTIFICATION_EDITOR_SETTINGS_CHANGED = 10000;
}
...
export namespace VisualShaderNodeColorConstant {
}
...
export interface Path2D extends Node2D {
  curve: { type: "Curve2D" , properties: Curve2D };  
}
...
export namespace InputEventAction {
}
...
export namespace ImageFormatLoader {export const enum LoaderFlags {
  FLAG_NONE = 0,
  FLAG_FORCE_LINEAR = 1,
...
export namespace TextureCubemapRD {
}
...
export interface VideoStreamPlayer extends Control {
  ...
  loop: type.bool;
  paused: type.bool;
  stream: { type: "VideoStream" , properties: VideoStream };
  stream_position: type.float;
  volume: type.float;
  volume_db: type.float;  
}

export namespace VideoStreamPlayer {
}
...
export namespace VisualShaderNodeUVFunc {export const enum Function {
  FUNC_PANNING = 0,
  FUNC_SCALING = 1,
  FUNC_MAX = 2,
}
...
export namespace GPUParticlesCollisionSphere3D {
}
...
export namespace EditorScenePostImport {
}
...
export namespace PhysicalBoneSimulator3D {
}
...
export namespace VisualShaderNodeVaryingSetter {
}
...
export namespace AESContext {export const enum Mode {
  MODE_ECB_ENCRYPT = 0,
  MODE_ECB_DECRYPT = 1,
  MODE_CBC_ENCRYPT = 2,
  MODE_CBC_DECRYPT = 3,
...
export namespace InputEventWithModifiers {
}
...
export namespace EditorSceneFormatImporter {
export const IMPORT_SCENE = 1;
export const IMPORT_ANIMATION = 2;
export const IMPORT_FAIL_ON_MISSING_DEPENDENCIES = 4;
export const IMPORT_GENERATE_TANGENT_ARRAYS = 8;
export const IMPORT_USE_NAMED_SKIN_BINDS = 16;
export const IMPORT_DISCARD_MESHES_AND_MATERIALS = 32;
export const IMPORT_FORCE_DISABLE_MESH_COMPRESSION = 64;
}
...
export namespace PacketPeerExtension {
}
...
export namespace PhysicsDirectBodyState2D {
}
...
export namespace ResourceImporterBMFont {
}
...
export namespace PhysicsServer3DRenderingServerHandler {
}
...
export namespace KinematicCollision3D {
}
...
export namespace ResourceFormatSaver {
}


export interface RDPipelineSpecializationConstant extends RefCounted {
  constant_id: type.int;
  value: { type: "Variant" , properties: Variant };  
}

export namespace RDPipelineSpecializationConstant {
}


export interface MeshTexture extends Texture2D {
  base_texture: { type: "Texture2D" , properties: Texture2D };
  image_size: type.Vector2;
  mesh: { type: "Mesh" , properties: Mesh };
  resource_local_to_scene: type.bool;  
}

export namespace MeshTexture {
}
...
export namespace RDVertexAttribute {
}
...
export namespace GDExtension {export const enum InitializationLevel {
...
export namespace GDExtensionManager {export const enum LoadStatus {
  LOAD_STATUS_OK = 0,
...
export namespace VisualShaderNodeIntFunc {export const enum Function {
  FUNC_ABS = 0,
  FUNC_NEGATE = 1,
  FUNC_SIGN = 2,
  FUNC_BITWISE_NOT = 3,
...
export namespace VisualShaderNodeUIntParameter {
}


export interface CurveXYZTexture extends Texture2D {
  curve_x: { type: "Curve" , properties: Curve };
  curve_y: { type: "Curve" , properties: Curve };
  curve_z: { type: "Curve" , properties: Curve };
  resource_local_to_scene: type.bool;
  width: type.int;  
}

export namespace CurveXYZTexture {
}
...
export namespace AnimatedSprite3D {
}
...
export namespace GrooveJoint2D {
}
...
export namespace PhysicsTestMotionParameters3D {
}
...
export namespace TileSetAtlasSource {export const enum TileAnimationMode {
...
export const TRANSFORM_FLIP_H = 4096;
export const TRANSFORM_FLIP_V = 8192;
export const TRANSFORM_TRANSPOSE = 16384;
}
...
export namespace GPUParticlesAttractor3D {
}
...
export namespace CameraAttributesPractical {
}
...
export namespace Light2D {export const enum ShadowFilter {
...
export namespace VisualShaderNodeGlobalExpression {
}
...
export namespace IP {export const enum ResolverStatus {
...
export const RESOLVER_MAX_QUERIES = 256;
export const RESOLVER_INVALID_ID = -1;
...
export interface NavigationPathQueryResult2D extends RefCounted {
  ...
  path_rids: { type: "RID[]" , properties: RID[] };
  path_types: type.PackedInt32Array;  
}

export namespace NavigationPathQueryResult2D {export const enum PathSegmentType {
...
export interface Font extends Resource {
  fallbacks: { type: "Font[]" , properties: Font[] };  
}
...
export namespace SkeletonProfileHumanoid {
}
...
export namespace LightmapperRD {
}
...
export namespace StandardMaterial3D {
}
...
export namespace XRPose {export const enum TrackingConfidence {
...
export namespace SliderJoint3D {export const enum Param {
...
export namespace AnimationNodeBlend2 {
}
...
export namespace AudioEffectLowShelfFilter {
}
...
export namespace VisualShaderNodeTexture2DArrayParameter {
}
...
export namespace VisualShaderNodeTransformParameter {
}


export interface NavigationPathQueryParameters2D extends RefCounted {
  map: { type: "RID" , properties: RID };
...
export namespace NavigationPathQueryParameters2D {export const enum PathfindingAlgorithm {
  PATHFINDING_ALGORITHM_ASTAR = 0,
}

export const enum PathPostProcessing {
  PATH_POSTPROCESSING_CORRIDORFUNNEL = 0,
  PATH_POSTPROCESSING_EDGECENTERED = 1,
}

export const enum PathMetadataFlags {
...
export namespace AudioEffectEQ6 {
}
...
export namespace VisualShaderNodeBooleanConstant {
}
...
export namespace RDPipelineDepthStencilState {
}
...
export namespace EditorExportPlatformExtension {
}
...
export interface TubeTrailMesh extends PrimitiveMesh {
  ...
  cap_top: type.bool;
  curve: { type: "Curve" , properties: Curve };
...
export namespace TubeTrailMesh {
}


export interface VisualShaderNodeCubemap extends VisualShaderNode {
  cube_map: { type: "TextureLayered" , properties: TextureLayered };
  source: type.int;
  texture_type: type.int;  
}

export namespace VisualShaderNodeCubemap {export const enum Source {
  SOURCE_TEXTURE = 0,
  SOURCE_PORT = 1,
  SOURCE_MAX = 2,
}
...
export namespace TextServerManager {
}
...
export namespace Timer {export const enum TimerProcessCallback {
...
export namespace VisibleOnScreenNotifier3D {
}
...
export namespace ShaderInclude {
}
...
export namespace AudioStreamPolyphonic {
}
...
export namespace PlaneMesh {export const enum Orientation {
  FACE_X = 0,
  FACE_Y = 1,
  FACE_Z = 2,
}
...
export interface Node extends Object {
  ...
  multiplayer: { type: "MultiplayerAPI" , properties: MultiplayerAPI };
  name: type.StringName;
  owner: { type: "Node" , properties: Node };
  physics_interpolation_mode: type.int;
...
export const NOTIFICATION_SCENE_INSTANTIATED = 20;
export const NOTIFICATION_DRAG_BEGIN = 21;
export const NOTIFICATION_DRAG_END = 22;
export const NOTIFICATION_PATH_RENAMED = 23;
export const NOTIFICATION_CHILD_ORDER_CHANGED = 24;
...
export const NOTIFICATION_DISABLED = 28;
export const NOTIFICATION_ENABLED = 29;
export const NOTIFICATION_RESET_PHYSICS_INTERPOLATION = 2001;
export const NOTIFICATION_EDITOR_PRE_SAVE = 9001;
export const NOTIFICATION_EDITOR_POST_SAVE = 9002;
export const NOTIFICATION_WM_MOUSE_ENTER = 1002;
export const NOTIFICATION_WM_MOUSE_EXIT = 1003;
export const NOTIFICATION_WM_WINDOW_FOCUS_IN = 1004;
export const NOTIFICATION_WM_WINDOW_FOCUS_OUT = 1005;
export const NOTIFICATION_WM_CLOSE_REQUEST = 1006;
export const NOTIFICATION_WM_GO_BACK_REQUEST = 1007;
export const NOTIFICATION_WM_SIZE_CHANGED = 1008;
export const NOTIFICATION_WM_DPI_CHANGE = 1009;
export const NOTIFICATION_VP_MOUSE_ENTER = 1010;
export const NOTIFICATION_VP_MOUSE_EXIT = 1011;
export const NOTIFICATION_OS_MEMORY_WARNING = 2009;
export const NOTIFICATION_TRANSLATION_CHANGED = 2010;
export const NOTIFICATION_WM_ABOUT = 2011;
export const NOTIFICATION_CRASH = 2012;
export const NOTIFICATION_OS_IME_UPDATE = 2013;
export const NOTIFICATION_APPLICATION_RESUMED = 2014;
export const NOTIFICATION_APPLICATION_PAUSED = 2015;
export const NOTIFICATION_APPLICATION_FOCUS_IN = 2016;
export const NOTIFICATION_APPLICATION_FOCUS_OUT = 2017;
export const NOTIFICATION_TEXT_SERVER_CHANGED = 2018;
...
export const enum ProcessThreadGroup {
  PROCESS_THREAD_GROUP_INHERIT = 0,
  PROCESS_THREAD_GROUP_MAIN_THREAD = 1,
  PROCESS_THREAD_GROUP_SUB_THREAD = 2,
}

export const enum ProcessThreadMessages {
  FLAG_PROCESS_THREAD_MESSAGES = 1,
  FLAG_PROCESS_THREAD_MESSAGES_PHYSICS = 2,
  FLAG_PROCESS_THREAD_MESSAGES_ALL = 3,
}

export const enum PhysicsInterpolationMode {
  PHYSICS_INTERPOLATION_MODE_INHERIT = 0,
  PHYSICS_INTERPOLATION_MODE_ON = 1,
  PHYSICS_INTERPOLATION_MODE_OFF = 2,
}

export const enum DuplicateFlags {
  DUPLICATE_SIGNALS = 1,
  DUPLICATE_GROUPS = 2,
  DUPLICATE_SCRIPTS = 4,
...
export const enum InternalMode {
  INTERNAL_MODE_DISABLED = 0,
  INTERNAL_MODE_FRONT = 1,
  INTERNAL_MODE_BACK = 2,
}

export const enum AutoTranslateMode {
...
export namespace PhysicsRayQueryParameters3D {
}
...
export namespace EditorResourceConversionPlugin {
}
...
export namespace VisualShaderNodeClamp {export const enum OpType {
  OP_TYPE_FLOAT = 0,
  OP_TYPE_INT = 1,
  OP_TYPE_UINT = 2,
  OP_TYPE_VECTOR_2D = 3,
...
export namespace VisualShaderNodeTransformFunc {export const enum Function {
  FUNC_INVERSE = 0,
  FUNC_TRANSPOSE = 1,
  FUNC_MAX = 2,
}
...
export namespace AnimationNodeBlend3 {
}
...
export namespace ScriptCreateDialog {
}
...
export namespace JavaClassWrapper {
}
...
export namespace CompressedCubemapArray {
}
...
export const NOTIFICATION_EXTENSION_RELOADED = 2;
...
export namespace IntervalTweener {
}
...
export namespace VisualShaderNodeScreenUVToSDF {
}
...
export namespace SkeletonModificationStack2D {
}
...
export namespace VisualShaderNodeDotProduct {
}
...
export namespace VisualShaderNodeColorParameter {
}
...
export namespace CameraAttributesPhysical {
}
...
export interface ResourceImporterDynamicFont extends ResourceImporter {
  ...
  hinting: type.int;
  language_support: { type: "Dictionary" , properties: Dictionary };
  msdf_pixel_range: type.int;
  msdf_size: type.int;
  multichannel_signed_distance_field: type.bool;
  opentype_features: { type: "Dictionary" , properties: Dictionary };
  oversampling: type.float;
  preload: type.Array;
  script_support: { type: "Dictionary" , properties: Dictionary };
  subpixel_positioning: type.int;  
}

export namespace ResourceImporterDynamicFont {
}
...
export namespace AnimationNodeStateMachinePlayback {
}
...
export namespace JavaScriptObject {
}
...
export namespace TextServer {export const enum FontAntialiasing {
  FONT_ANTIALIASING_NONE = 0,
  FONT_ANTIALIASING_GRAY = 1,
  FONT_ANTIALIASING_LCD = 2,
}

export const enum FontLCDSubpixelLayout {
...
export const enum JustificationFlag {
...
export const enum AutowrapMode {
  AUTOWRAP_OFF = 0,
...
export const enum LineBreakFlag {
  BREAK_NONE = 0,
  BREAK_MANDATORY = 1,
  BREAK_WORD_BOUND = 2,
...
export const enum VisibleCharactersBehavior {
...
export const enum OverrunBehavior {
...
export const enum TextOverrunFlag {
  OVERRUN_NO_TRIM = 0,
  OVERRUN_TRIM = 1,
...
export const enum GraphemeFlag {
  GRAPHEME_IS_VALID = 1,
  GRAPHEME_IS_RTL = 2,
...
export const enum Hinting {
  HINTING_NONE = 0,
  HINTING_LIGHT = 1,
  HINTING_NORMAL = 2,
}

export const enum SubpixelPositioning {
...
export const enum ContourPointTag {
  CONTOUR_CURVE_TAG_ON = 1,
  CONTOUR_CURVE_TAG_OFF_CONIC = 0,
  CONTOUR_CURVE_TAG_OFF_CUBIC = 2,
}

export const enum SpacingType {
  SPACING_GLYPH = 0,
  SPACING_SPACE = 1,
  SPACING_TOP = 2,
  SPACING_BOTTOM = 3,
...
export const enum StructuredTextParser {
...
export const enum FixedSizeScaleMode {
...
export namespace VideoStreamPlayback {
}
...
export namespace InputEventScreenTouch {
}
...
export namespace VisualShaderNodeProximityFade {
}
...
export namespace VisualShaderNodeVec2Constant {
}
...
export namespace Generic6DOFJoint3D {export const enum Param {
...
export namespace InputEventShortcut {
}
...
export namespace ItemList {export const enum IconMode {
  ICON_MODE_TOP = 0,
  ICON_MODE_LEFT = 1,
}
...
export interface RenderSceneBuffersConfiguration extends RefCounted {
  ...
  msaa_3d: type.int;
  render_target: { type: "RID" , properties: RID };
  scaling_3d_mode: type.int;
  screen_space_aa: type.int;
...
export namespace RenderSceneBuffersConfiguration {
}
...
export interface OccluderInstance3D extends VisualInstance3D {
  ...
  occluder: { type: "Occluder3D" , properties: Occluder3D };  
}

export namespace OccluderInstance3D {
}
...
export namespace XRControllerTracker {
}
...
export namespace CapsuleMesh {
}


export interface MultiMeshInstance3D extends GeometryInstance3D {
  multimesh: { type: "MultiMesh" , properties: MultiMesh };  
}

export namespace MultiMeshInstance3D {
}
...
export namespace EditorResourceTooltipPlugin {
}
...
export namespace NavigationAgent3D {
}
...
export namespace EditorExportPlatformPC {
}
...
export interface ArrayMesh extends Mesh {
  ...
  custom_aabb: type.AABB;
  shadow_mesh: { type: "ArrayMesh" , properties: ArrayMesh };  
}

export namespace ArrayMesh {
}
...
export namespace SkeletonModifier3D {
}
...
export namespace AudioEffectBandLimitFilter {
}
...
export namespace ScrollContainer {export const enum ScrollMode {
...
export interface ShapeCast3D extends Node3D {
  ...
  shape: { type: "Shape3D" , properties: Shape3D };
  target_position: type.Vector3;  
}

export namespace ShapeCast3D {
}
...
export namespace EditorExportPlugin {
}
...
export interface EditorResourcePicker extends HBoxContainer {
  ...
  editable: type.bool;
  edited_resource: { type: "Resource" , properties: Resource };
  toggle_mode: type.bool;  
}

export namespace EditorResourcePicker {
}
...
export namespace XRInterfaceExtension {
}
...
export namespace EditorResourcePreviewGenerator {
}
...
export namespace RigidBody2D {export const enum FreezeMode {
  FREEZE_MODE_STATIC = 0,
  FREEZE_MODE_KINEMATIC = 1,
}

export const enum CenterOfMassMode {
  CENTER_OF_MASS_MODE_AUTO = 0,
  CENTER_OF_MASS_MODE_CUSTOM = 1,
}

export const enum DampMode {
  DAMP_MODE_COMBINE = 0,
  DAMP_MODE_REPLACE = 1,
}

export const enum CCDMode {
  CCD_MODE_DISABLED = 0,
  CCD_MODE_CAST_RAY = 1,
...
export namespace PhysicsServer3D {export const enum JointType {
  JOINT_TYPE_PIN = 0,
  JOINT_TYPE_HINGE = 1,
  JOINT_TYPE_SLIDER = 2,
...
export const enum PinJointParam {
  PIN_JOINT_BIAS = 0,
  PIN_JOINT_DAMPING = 1,
  PIN_JOINT_IMPULSE_CLAMP = 2,
}

export const enum HingeJointParam {
  HINGE_JOINT_BIAS = 0,
...
export const enum HingeJointFlag {
  HINGE_JOINT_FLAG_USE_LIMIT = 0,
  HINGE_JOINT_FLAG_ENABLE_MOTOR = 1,
}

export const enum SliderJointParam {
...
export const enum ConeTwistJointParam {
...
export const enum G6DOFJointAxisParam {
...
export const enum G6DOFJointAxisFlag {
...
export const enum AreaParameter {
...
export const enum AreaSpaceOverrideMode {
...
export const enum BodyParameter {
  BODY_PARAM_BOUNCE = 0,
...
export const enum BodyDampMode {
...
export const enum AreaBodyStatus {
  AREA_BODY_ADDED = 0,
  AREA_BODY_REMOVED = 1,
}

export const enum ProcessInfo {
  INFO_ACTIVE_OBJECTS = 0,
  INFO_COLLISION_PAIRS = 1,
  INFO_ISLAND_COUNT = 2,
}

export const enum SpaceParameter {
...
export namespace VScrollBar {
}


export interface TouchScreenButton extends Node2D {
  action: type.String;
  bitmask: { type: "BitMap" , properties: BitMap };
  passby_press: type.bool;
  shape: { type: "Shape2D" , properties: Shape2D };
...
export namespace TouchScreenButton {export const enum VisibilityMode {
  VISIBILITY_ALWAYS = 0,
...
export namespace RDShaderSPIRV {
}
...
export namespace ReferenceRect {
}
...
export namespace CollisionShape2D {
}
...
export namespace NavigationObstacle3D {
}
...
export namespace CollisionObject3D {export const enum DisableMode {
...
export namespace HeightMapShape3D {
}
...
export namespace AudioStreamPlayback {
}
...
export const NOTIFICATION_VISIBILITY_CHANGED = 30;
export const NOTIFICATION_THEME_CHANGED = 32;
...
export const enum ContentScaleMode {
  CONTENT_SCALE_MODE_DISABLED = 0,
  CONTENT_SCALE_MODE_CANVAS_ITEMS = 1,
  CONTENT_SCALE_MODE_VIEWPORT = 2,
}

export const enum ContentScaleAspect {
...
export const enum ContentScaleStretch {
...
export const enum WindowInitialPosition {
...
export namespace RemoteTransform3D {
}
...
export namespace CurveTexture {export const enum TextureMode {
  TEXTURE_MODE_RGB = 0,
  TEXTURE_MODE_RED = 1,
}
...
export namespace VisualShaderNodeParticleRingEmitter {
}
...
export namespace InputEventMIDI {
}
...
export namespace RemoteTransform2D {
}
...
export namespace InputEventMouse {
}
...
export namespace AudioEffectChorus {
}
...
export namespace MultiplayerPeerExtension {
}
...
export namespace LightmapProbe {
}
...
export interface Sky extends Resource {
  ...
  sky_material: { type: "Material" , properties: Material };  
}

export namespace Sky {export const enum RadianceSize {
  RADIANCE_SIZE_32 = 0,
  RADIANCE_SIZE_64 = 1,
  RADIANCE_SIZE_128 = 2,
  RADIANCE_SIZE_256 = 3,
...
export namespace NavigationObstacle2D {
}
...
export namespace CollisionObject2D {export const enum DisableMode {
  DISABLE_MODE_REMOVE = 0,
  DISABLE_MODE_MAKE_STATIC = 1,
  DISABLE_MODE_KEEP_ACTIVE = 2,
}
...
export namespace AnimationNodeTimeScale {
}
...
export namespace CollisionShape3D {
}
...
export namespace EditorSpinSlider {
}
...
export namespace FileDialog {export const enum FileMode {
  FILE_MODE_OPEN_FILE = 0,
  FILE_MODE_OPEN_FILES = 1,
  FILE_MODE_OPEN_DIR = 2,
  FILE_MODE_OPEN_ANY = 3,
...
export namespace AudioEffectReverb {
}
...
export interface AnimationNodeOneShot extends AnimationNodeSync {
  ...
  fadein_curve: { type: "Curve" , properties: Curve };
  fadein_time: type.float;
  fadeout_curve: { type: "Curve" , properties: Curve };
  fadeout_time: type.float;
  mix_mode: type.int;  
}

export namespace AnimationNodeOneShot {export const enum OneShotRequest {
...
export namespace RigidBody3D {export const enum FreezeMode {
  FREEZE_MODE_STATIC = 0,
  FREEZE_MODE_KINEMATIC = 1,
}
...
export namespace PhysicsServer2D {export const enum SpaceParameter {
  SPACE_PARAM_CONTACT_RECYCLE_RADIUS = 0,
  SPACE_PARAM_CONTACT_MAX_SEPARATION = 1,
  SPACE_PARAM_CONTACT_MAX_ALLOWED_PENETRATION = 2,
  SPACE_PARAM_CONTACT_DEFAULT_BIAS = 3,
...
export namespace Shader {export const enum Mode {
  MODE_SPATIAL = 0,
  MODE_CANVAS_ITEM = 1,
  MODE_PARTICLES = 2,
  MODE_SKY = 3,
...
export namespace VisualShaderNodeComment {
}
...
export namespace WorldEnvironment {
}
...
export namespace GradientTexture1D {
}
...
export namespace ResourceImporterOBJ {
}
...
export namespace MultiMeshInstance2D {
}
...
export namespace XRHandModifier3D {export const enum BoneUpdate {
  BONE_UPDATE_FULL = 0,
  BONE_UPDATE_ROTATION_ONLY = 1,
  BONE_UPDATE_MAX = 2,
}
...
export namespace EditorUndoRedoManager {export const enum SpecialHistory {
  GLOBAL_HISTORY = 0,
  REMOTE_HISTORY = -9,
  INVALID_HISTORY = -99,
}
...
export namespace NavigationAgent2D {
}
...
export namespace StreamPeerGZIP {
}
...
export namespace InputEventScreenDrag {
}
...
export namespace VisualShaderNodeFresnel {
}
...
export namespace ResourceImporterShaderFile {
}
...
export namespace AnimatedTexture {
...
export namespace MethodTweener {
}
...
export namespace HBoxContainer {
}
...
export interface AnimationNodeStateMachineTransition extends Resource {
  ...
  xfade_curve: { type: "Curve" , properties: Curve };
  xfade_time: type.float;  
}

export namespace AnimationNodeStateMachineTransition {export const enum SwitchMode {
  SWITCH_MODE_IMMEDIATE = 0,
  SWITCH_MODE_SYNC = 1,
  SWITCH_MODE_AT_END = 2,
}

export const enum AdvanceMode {
...
export namespace MissingResource {
}
...
export namespace Tree {export const enum SelectMode {
  SELECT_SINGLE = 0,
  SELECT_ROW = 1,
  SELECT_MULTI = 2,
}

export const enum DropModeFlags {
...
export namespace RDFramebufferPass {
...
export namespace VisualShaderNodeCustom {
}
...
export namespace ResourceImporterCSVTranslation {
}
...
export namespace EditorSyntaxHighlighter {
}
...
export namespace VisualShaderNodeFaceForward {
}


export interface RDPipelineColorBlendState extends RefCounted {
  attachments: { type: "RDPipelineColorBlendStateAttachment[]" , properties: RDPipelineColorBlendStateAttachment[] };
  blend_constant: type.Color;
  enable_logic_op: type.bool;
  logic_op: type.int;  
}

export namespace RDPipelineColorBlendState {
}
...
export namespace AudioStreamWAV {export const enum Format {
  FORMAT_8_BITS = 0,
  FORMAT_16_BITS = 1,
  FORMAT_IMA_ADPCM = 2,
  FORMAT_QOA = 3,
...
export namespace ResourceImporter {export const enum ImportOrder {
...
export namespace OmniLight3D {export const enum ShadowMode {
...
export namespace TranslationDomain {
}
...
export namespace VisualShaderNodeCubemapParameter {
}
...
export interface PacketPeerStream extends PacketPeer {
  ...
  stream_peer: { type: "StreamPeer" , properties: StreamPeer };  
}

export namespace PacketPeerStream {
}
...
export namespace RichTextEffect {
}
...
export namespace VisualShaderNodeTexture {export const enum Source {
  SOURCE_TEXTURE = 0,
  SOURCE_SCREEN = 1,
  SOURCE_2D_TEXTURE = 2,
  SOURCE_2D_NORMAL = 3,
...
export namespace ImporterMeshInstance3D {
}
...
export namespace AudioEffectPanner {
}
...
export namespace PlaceholderTexture2DArray {
}
...
export namespace VisualShaderNodeParticleAccelerator {export const enum Mode {
  MODE_LINEAR = 0,
  MODE_RADIAL = 1,
  MODE_TANGENTIAL = 2,
  MODE_MAX = 3,
...
export namespace PhysicsRayQueryParameters2D {
}
...
export namespace VisualShaderNodeUIntConstant {
}
...
export namespace AudioStreamGenerator {
}


export interface AtlasTexture extends Texture2D {
  atlas: { type: "Texture2D" , properties: Texture2D };
...
export namespace RenderSceneDataExtension {
}
...
export namespace EditorDebuggerPlugin {
}
...
export namespace VisualShaderNodeExpression {
}
...
export namespace ExternalTexture {
}
...
export namespace VisibleOnScreenNotifier2D {
}
...
export namespace BackBufferCopy {export const enum CopyMode {
...
export namespace EditorFeatureProfile {export const enum Feature {
  FEATURE_3D = 0,
  FEATURE_SCRIPT = 1,
  FEATURE_ASSET_LIB = 2,
...
export namespace VisualShaderNodeTextureSDFNormal {
}
...
export namespace Texture2DArrayRD {
}
...
export namespace EditorResourcePreview {
}
...
export namespace VisualShaderNodeBooleanParameter {
}
...
export namespace TreeItem {export const enum TreeCellMode {
  CELL_MODE_STRING = 0,
  CELL_MODE_CHECK = 1,
  CELL_MODE_RANGE = 2,
  CELL_MODE_ICON = 3,
...
export namespace GPUParticlesCollisionBox3D {
}
...
export interface CodeEdit extends TextEdit {
  ...
  auto_brace_completion_pairs: { type: "Dictionary" , properties: Dictionary };
  code_completion_enabled: type.bool;
  code_completion_prefixes: { type: "String[]" , properties: String[] };
  delimiter_comments: { type: "String[]" , properties: String[] };
  delimiter_strings: { type: "String[]" , properties: String[] };
  ...
  indent_automatic_prefixes: { type: "String[]" , properties: String[] };
  indent_size: type.int;
  indent_use_spaces: type.bool;
  layout_direction: type.int;
  line_folding: type.bool;
  line_length_guidelines: { type: "int[]" , properties: int[] };
  symbol_lookup_on_click: type.bool;
  text_direction: type.int;  
}

export namespace CodeEdit {export const enum CodeCompletionKind {
  KIND_CLASS = 0,
  KIND_FUNCTION = 1,
  KIND_SIGNAL = 2,
  KIND_VARIABLE = 3,
...
export const enum CodeCompletionLocation {
  LOCATION_LOCAL = 0,
...
export interface FontVariation extends Font {
  base_font: { type: "Font" , properties: Font };
  ...
  variation_opentype: { type: "Dictionary" , properties: Dictionary };
  variation_transform: type.Transform2D;  
}

export namespace FontVariation {
}
...
export namespace NavigationPathQueryParameters3D {export const enum PathfindingAlgorithm {
  PATHFINDING_ALGORITHM_ASTAR = 0,
}
...
export namespace SkeletonProfile {export const enum TailDirection {
...
export namespace InputEventJoypadButton {
}
...
export namespace UndoRedo {export const enum MergeMode {
  MERGE_DISABLE = 0,
  MERGE_ENDS = 1,
  MERGE_ALL = 2,
}
...
export namespace PhysicsDirectBodyState3DExtension {
}
...
export namespace CameraServer {export const enum FeedImage {
  FEED_RGBA_IMAGE = 0,
  FEED_YCBCR_IMAGE = 0,
  FEED_Y_IMAGE = 0,
  FEED_CBCR_IMAGE = 1,
...
export namespace PhysicsServer3DExtension {
}
...
export interface ProceduralSkyMaterial extends Material {
  ...
  sky_cover: { type: "Texture2D" , properties: Texture2D };
...
export namespace ProceduralSkyMaterial {
}
...
export namespace InstancePlaceholder {
}
...
export namespace NavigationPathQueryResult3D {export const enum PathSegmentType {
  PATH_SEGMENT_TYPE_REGION = 0,
  PATH_SEGMENT_TYPE_LINK = 1,
}
...
export namespace PlaceholderCubemapArray {
}
...
export namespace OS {export const enum RenderingDriver {
...
export namespace TextureRect {export const enum ExpandMode {
  EXPAND_KEEP_SIZE = 0,
...
export namespace VisualShaderNodeSDFRaymarch {
}
...
export namespace AudioEffectPitchShift {export const enum FFTSize {
  FFT_SIZE_256 = 0,
  FFT_SIZE_512 = 1,
  FFT_SIZE_1024 = 2,
  FFT_SIZE_2048 = 3,
...
export namespace ResourceImporterWAV {
}
...
export namespace Mesh {export const enum PrimitiveType {
  PRIMITIVE_POINTS = 0,
  PRIMITIVE_LINES = 1,
  PRIMITIVE_LINE_STRIP = 2,
  PRIMITIVE_TRIANGLES = 3,
...
export namespace VSplitContainer {
}
...
export namespace Input {export const enum MouseMode {
...
export namespace AudioStreamPlaybackResampled {
}
...
export namespace AudioEffectDelay {
}
...
export namespace RDTextureFormat {
}
...
export namespace PrimitiveMesh {
}
...
export namespace PlaceholderTexture2D {
}
...
export namespace ColorPicker {export const enum ColorModeType {
  MODE_RGB = 0,
  MODE_HSV = 1,
  MODE_RAW = 2,
  MODE_OKHSL = 3,
...
export const enum PickerShapeType {
...
export namespace AudioListener2D {
}
...
export namespace AnimationNodeTimeSeek {
}
...
export namespace VisualShaderNodeTextureSDF {
}
...
export namespace Tween {export const enum TweenProcessMode {
  TWEEN_PROCESS_PHYSICS = 0,
  TWEEN_PROCESS_IDLE = 1,
}

export const enum TweenPauseMode {
  TWEEN_PAUSE_BOUND = 0,
  TWEEN_PAUSE_STOP = 1,
...
export namespace TabBar {export const enum AlignmentMode {
  ALIGNMENT_LEFT = 0,
  ALIGNMENT_CENTER = 1,
  ALIGNMENT_RIGHT = 2,
  ALIGNMENT_MAX = 3,
...
export const enum CloseButtonDisplayPolicy {
...
export namespace EditorProperty {
}
...
export namespace AspectRatioContainer {export const enum StretchMode {
...
export namespace SubViewport {export const enum ClearMode {
  CLEAR_MODE_ALWAYS = 0,
  CLEAR_MODE_NEVER = 1,
  CLEAR_MODE_ONCE = 2,
}
...
export namespace TileSet {export const enum TileShape {
  TILE_SHAPE_SQUARE = 0,
...
export const enum TileOffsetAxis {
  TILE_OFFSET_AXIS_HORIZONTAL = 0,
  TILE_OFFSET_AXIS_VERTICAL = 1,
}

export const enum CellNeighbor {
...
export namespace AudioEffectEQ21 {
}
...
export namespace RenderingDevice {export const enum DeviceType {
  DEVICE_TYPE_OTHER = 0,
...
export const enum DriverResource {
...
export const enum TextureSamples {
  TEXTURE_SAMPLES_1 = 0,
  TEXTURE_SAMPLES_2 = 1,
  TEXTURE_SAMPLES_4 = 2,
  TEXTURE_SAMPLES_8 = 3,
...
export const enum TextureUsageBits {
...
export const enum TextureSwizzle {
...
export const enum TextureSliceType {
  TEXTURE_SLICE_2D = 0,
  TEXTURE_SLICE_CUBEMAP = 1,
  TEXTURE_SLICE_3D = 2,
}

export const enum SamplerFilter {
  SAMPLER_FILTER_NEAREST = 0,
  SAMPLER_FILTER_LINEAR = 1,
}

export const enum SamplerRepeatMode {
...
export const enum SamplerBorderColor {
...
export const enum VertexFrequency {
  VERTEX_FREQUENCY_VERTEX = 0,
  VERTEX_FREQUENCY_INSTANCE = 1,
}

export const enum IndexBufferFormat {
  INDEX_BUFFER_FORMAT_UINT16 = 0,
  INDEX_BUFFER_FORMAT_UINT32 = 1,
}

export const enum StorageBufferUsage {
...
export const enum RenderPrimitive {
...
export const enum PolygonCullMode {
  POLYGON_CULL_DISABLED = 0,
  POLYGON_CULL_FRONT = 1,
  POLYGON_CULL_BACK = 2,
}

export const enum PolygonFrontFace {
...
export const enum LogicOperation {
  LOGIC_OP_CLEAR = 0,
  LOGIC_OP_AND = 1,
...
export const enum PipelineDynamicStateFlags {
...
export const enum InitialAction {
...
export const enum PipelineSpecializationConstantType {
...
export const INVALID_ID = -1;
export const INVALID_FORMAT_ID = -1;
export const enum BreadcrumbMarker {
  NONE = 0,
...
export namespace Performance {export const enum Monitor {
  TIME_FPS = 0,
  TIME_PROCESS = 1,
...
export namespace VisualShaderNodeBillboard {export const enum BillboardType {
...
export namespace PhysicsDirectSpaceState2DExtension {
}
...
export namespace EngineDebugger {
}


export interface BoneMap extends Resource {
  profile: { type: "SkeletonProfile" , properties: SkeletonProfile };  
}

export namespace BoneMap {
}
...
export namespace AnimationNodeSync {
}
...
export namespace Label3D {export const enum DrawFlags {
  FLAG_SHADED = 0,
  FLAG_DOUBLE_SIDED = 1,
...
export namespace VisualShaderNodeDistanceFade {
}


export interface BaseMaterial3D extends Material {
  albedo_color: type.Color;
  albedo_texture: { type: "Texture2D" , properties: Texture2D };
  ...
  anisotropy_flowmap: { type: "Texture2D" , properties: Texture2D };
  ao_enabled: type.bool;
  ao_light_affect: type.float;
  ao_on_uv2: type.bool;
  ao_texture: { type: "Texture2D" , properties: Texture2D };
  ao_texture_channel: type.int;
  backlight: type.Color;
  backlight_enabled: type.bool;
  backlight_texture: { type: "Texture2D" , properties: Texture2D };
  ...
  clearcoat_texture: { type: "Texture2D" , properties: Texture2D };
  cull_mode: type.int;
  depth_draw_mode: type.int;
  detail_albedo: { type: "Texture2D" , properties: Texture2D };
  detail_blend_mode: type.int;
  detail_enabled: type.bool;
  detail_mask: { type: "Texture2D" , properties: Texture2D };
  detail_normal: { type: "Texture2D" , properties: Texture2D };
  ...
  emission_texture: { type: "Texture2D" , properties: Texture2D };
  fixed_size: type.bool;
  grow: type.bool;
  ...
  heightmap_texture: { type: "Texture2D" , properties: Texture2D };
  metallic: type.float;
  metallic_specular: type.float;
  metallic_texture: { type: "Texture2D" , properties: Texture2D };
  ...
  normal_texture: { type: "Texture2D" , properties: Texture2D };
  orm_texture: { type: "Texture2D" , properties: Texture2D };
  particles_anim_h_frames: type.int;
  particles_anim_loop: type.bool;
  particles_anim_v_frames: type.int;
  ...
  refraction_texture: { type: "Texture2D" , properties: Texture2D };
  refraction_texture_channel: type.int;
  rim: type.float;
  rim_enabled: type.bool;
  rim_texture: { type: "Texture2D" , properties: Texture2D };
  rim_tint: type.float;
  roughness: type.float;
  roughness_texture: { type: "Texture2D" , properties: Texture2D };
  ...
  subsurf_scatter_texture: { type: "Texture2D" , properties: Texture2D };
  ...
  subsurf_scatter_transmittance_texture: { type: "Texture2D" , properties: Texture2D };
  texture_filter: type.int;
...
export namespace BaseMaterial3D {export const enum TextureParam {
  TEXTURE_ALBEDO = 0,
  TEXTURE_METALLIC = 1,
  TEXTURE_ROUGHNESS = 2,
  TEXTURE_EMISSION = 3,
...
export const enum SpecularMode {
...
export const enum TextureChannel {
...
export const enum EmissionOperator {
  EMISSION_OP_ADD = 0,
  EMISSION_OP_MULTIPLY = 1,
}

export const enum DistanceFadeMode {
...
export namespace RibbonTrailMesh {export const enum Shape {
  SHAPE_FLAT = 0,
  SHAPE_CROSS = 1,
}
...
export namespace VisualShaderNodeTransformDecompose {
}
...
export namespace Thread {export const enum Priority {
  PRIORITY_LOW = 0,
  PRIORITY_NORMAL = 1,
  PRIORITY_HIGH = 2,
}
...
export namespace CompressedCubemap {
}
...
export interface Decal extends VisualInstance3D {
  ...
  size: type.Vector3;
  texture_albedo: { type: "Texture2D" , properties: Texture2D };
  texture_emission: { type: "Texture2D" , properties: Texture2D };
  texture_normal: { type: "Texture2D" , properties: Texture2D };
  texture_orm: { type: "Texture2D" , properties: Texture2D };
  upper_fade: type.float;  
}

export namespace Decal {export const enum DecalTexture {
  TEXTURE_ALBEDO = 0,
  TEXTURE_NORMAL = 1,
  TEXTURE_ORM = 2,
  TEXTURE_EMISSION = 3,
...
export namespace ParallaxBackground {
}
...
export namespace ConeTwistJoint3D {export const enum Param {
  PARAM_SWING_SPAN = 0,
  PARAM_TWIST_SPAN = 1,
  PARAM_BIAS = 2,
  PARAM_SOFTNESS = 3,
...
export namespace AudioEffectRecord {
}
...
export namespace AudioStreamPlayer {export const enum MixTarget {
  MIX_TARGET_STEREO = 0,
...
export namespace GraphEdit {export const enum PanningScheme {
  SCROLL_ZOOMS = 0,
  SCROLL_PANS = 1,
}

export const enum GridPattern {
...
export namespace Sprite2D {
}


export interface LightOccluder2D extends Node2D {
  occluder: { type: "OccluderPolygon2D" , properties: OccluderPolygon2D };
  occluder_light_mask: type.int;
  sdf_collision: type.bool;  
}

export namespace LightOccluder2D {
}
...
export namespace PlaceholderCubemap {
}
...
export namespace HSplitContainer {
}
...
export namespace StreamPeerTLS {export const enum Status {
  STATUS_DISCONNECTED = 0,
...
export namespace ResourceImporterImage {
}
...
export namespace PackedDataContainerRef {
}
...
export namespace AnimationNodeAdd2 {
}
...
export namespace SplitContainer {export const enum DraggerVisibility {
  DRAGGER_VISIBLE = 0,
  DRAGGER_HIDDEN = 1,
...
export interface FontFile extends Font {
  ...
  msdf_size: type.int;
  multichannel_signed_distance_field: type.bool;
  opentype_feature_overrides: { type: "Dictionary" , properties: Dictionary };
  oversampling: type.float;
...
export namespace RDAttachmentFormat {
}
...
export namespace EditorExportPreset {export const enum ExportFilter {
...
export const enum FileExportMode {
...
export const enum ScriptExportMode {
  MODE_SCRIPT_TEXT = 0,
...
export namespace ColorPickerButton {
}
...
export namespace EditorContextMenuPlugin {export const enum ContextMenuSlot {
...
export namespace EditorImportPlugin {
}
...
export interface CharFXTransform extends RefCounted {
  ...
  env: { type: "Dictionary" , properties: Dictionary };
  font: { type: "RID" , properties: RID };
...
export namespace CharFXTransform {
}
...
export namespace VisualShaderNodeVectorCompose {
}
...
export namespace VisualShaderNodeIntOp {export const enum Operator {
  OP_ADD = 0,
  OP_SUB = 1,
  OP_MUL = 2,
  OP_DIV = 3,
...
export namespace EditorExportPlatform {export const enum ExportMessageType {
...
export namespace GPUParticlesCollision3D {
}
...
export namespace NavigationMeshSourceGeometryData3D {
}


export interface ResourceImporterScene extends ResourceImporter {
  _subresources: { type: "Dictionary" , properties: Dictionary };
...
export namespace ResourceImporterScene {
}
...
export namespace PlaceholderTextureLayered {
}
...
export namespace TextureLayered {export const enum LayeredType {
...
export interface NavigationRegion2D extends Node2D {
  ...
  enter_cost: type.float;
  navigation_layers: type.int;
  navigation_polygon: { type: "NavigationPolygon" , properties: NavigationPolygon };
  travel_cost: type.float;
  use_edge_connections: type.bool;  
}

export namespace NavigationRegion2D {
}
...
export namespace PolygonPathFinder {
}
...
export namespace VisualShaderNodeTransformOp {export const enum Operator {
  OP_AxB = 0,
  OP_BxA = 1,
  OP_AxB_COMP = 2,
  OP_BxA_COMP = 3,
...
export namespace DirectionalLight3D {export const enum ShadowMode {
  SHADOW_ORTHOGONAL = 0,
...
export namespace VisualShaderNodeVectorDecompose {
}
...
export namespace JSONRPC {export const enum ErrorCode {
  PARSE_ERROR = -32700,
...
export namespace VisualShaderNodeParticleOutput {
}
...
export interface RDPipelineMultisampleState extends RefCounted {
  ...
  sample_masks: { type: "int[]" , properties: int[] };  
}

export namespace RDPipelineMultisampleState {
}
...
export namespace SphereOccluder3D {
}
...
export interface LineEdit extends Control {
  ...
  mouse_default_cursor_shape: type.int;
  placeholder_text: type.String;
  right_icon: { type: "Texture2D" , properties: Texture2D };
  secret: type.bool;
...
export namespace LineEdit {export const enum MenuItems {
  MENU_CUT = 0,
  MENU_COPY = 1,
  MENU_PASTE = 2,
  MENU_CLEAR = 3,
...
export const enum VirtualKeyboardType {
...
export namespace StyleBoxEmpty {
}
...
export namespace HingeJoint3D {export const enum Param {
  PARAM_BIAS = 0,
  PARAM_LIMIT_UPPER = 1,
  PARAM_LIMIT_LOWER = 2,
  PARAM_LIMIT_BIAS = 3,
...
export namespace ResourceSaver {export const enum SaverFlags {
  FLAG_NONE = 0,
...
export namespace EditorFileSystemImportFormatSupportQuery {
}
...
export namespace VisualShaderNodeVec4Constant {
}
...
export namespace GPUParticlesCollisionSDF3D {export const enum Resolution {
  RESOLUTION_16 = 0,
  RESOLUTION_32 = 1,
  RESOLUTION_64 = 2,
  RESOLUTION_128 = 3,
...
export namespace QuadOccluder3D {
}
...
export namespace VisualShaderNodeParticleConeVelocity {
}
...
export namespace ScriptLanguageExtension {export const enum LookupResultType {
...
export const enum CodeCompletionKind {
...
export namespace AnimationNodeAdd3 {
}
...
export namespace ResourceLoader {export const enum ThreadLoadStatus {
...
export namespace AnimationNodeBlendTree {
export const CONNECTION_OK = 0;
export const CONNECTION_ERROR_NO_INPUT = 1;
export const CONNECTION_ERROR_NO_INPUT_INDEX = 2;
export const CONNECTION_ERROR_NO_OUTPUT = 3;
export const CONNECTION_ERROR_SAME_NODE = 4;
export const CONNECTION_ERROR_CONNECTION_EXISTS = 5;
}
...
export namespace GPUParticlesAttractorBox3D {
}
...
export namespace AnimationNodeBlendSpace1D {export const enum BlendMode {
  BLEND_MODE_INTERPOLATED = 0,
  BLEND_MODE_DISCRETE = 1,
  BLEND_MODE_DISCRETE_CARRY = 2,
}
...
export namespace XRController3D {
}
...
export namespace ShaderGlobalsOverride {
}
...
export namespace SceneTreeTimer {
}
...
export namespace HashingContext {export const enum HashType {
  HASH_MD5 = 0,
  HASH_SHA1 = 1,
  HASH_SHA256 = 2,
}
...
export namespace InputEventJoypadMotion {
}
...
export namespace InputEventFromWindow {
}
...
export interface PhysicalSkyMaterial extends Material {
  ...
  night_sky: { type: "Texture2D" , properties: Texture2D };
...
export namespace PhysicalSkyMaterial {
}
...
export namespace AudioServer {export const enum SpeakerMode {
...
export namespace EditorCommandPalette {
}
...
export namespace VisualShaderNodeSample3D {export const enum Source {
  SOURCE_TEXTURE = 0,
  SOURCE_PORT = 1,
  SOURCE_MAX = 2,
}
...
export namespace SegmentShape2D {
}
...
export namespace PathFollow3D {export const enum RotationMode {
  ROTATION_NONE = 0,
  ROTATION_Y = 1,
  ROTATION_XY = 2,
  ROTATION_XYZ = 3,
...
export namespace BoneAttachment3D {
}
...
export namespace VisualShaderNodeVarying {
}
...
export namespace Curve2D {
}


export interface XRServer extends Object {
  primary_interface: { type: "XRInterface" , properties: XRInterface };
  world_origin: type.Transform3D;
  world_scale: type.float;  
}

export namespace XRServer {export const enum TrackerType {
  TRACKER_HEAD = 1,
...
export namespace EditorFileSystemDirectory {
}
...
export namespace EditorPlugin {export const enum CustomControlContainer {
  CONTAINER_TOOLBAR = 0,
...
export const enum AfterGUIInput {
...
export namespace VisualShaderNodeDerivativeFunc {export const enum OpType {
  OP_TYPE_SCALAR = 0,
  OP_TYPE_VECTOR_2D = 1,
  OP_TYPE_VECTOR_3D = 2,
  OP_TYPE_VECTOR_4D = 3,
...
export namespace SoftBody3D {export const enum DisableMode {
  DISABLE_MODE_REMOVE = 0,
...
export namespace DirectionalLight2D {
}
...
export namespace BoxContainer {export const enum AlignmentMode {
  ALIGNMENT_BEGIN = 0,
  ALIGNMENT_CENTER = 1,
  ALIGNMENT_END = 2,
}
...
export interface NavigationRegion3D extends Node3D {
  ...
  enter_cost: type.float;
  navigation_layers: type.int;
  navigation_mesh: { type: "NavigationMesh" , properties: NavigationMesh };
  travel_cost: type.float;
  use_edge_connections: type.bool;  
}

export namespace NavigationRegion3D {
}
...
export namespace NavigationMeshSourceGeometryData2D {
}
...
export namespace DampedSpringJoint2D {
}
...
export namespace VisualShaderNodeRandomRange {
}
...
export namespace AudioEffectSpectrumAnalyzerInstance {export const enum MagnitudeMode {
  MAGNITUDE_AVERAGE = 0,
  MAGNITUDE_MAX = 1,
}
...
export namespace AudioSamplePlayback {
}
...
export namespace PackedDataContainer {
}
...
export namespace SkeletonModification2D {
}
...
export namespace Curve {export const enum TangentMode {
  TANGENT_FREE = 0,
  TANGENT_LINEAR = 1,
...
export namespace AudioEffectLowPassFilter {
}
...
export namespace TabContainer {export const enum TabPosition {
  POSITION_TOP = 0,
  POSITION_BOTTOM = 1,
  POSITION_MAX = 2,
}
...
export namespace ImageFormatLoaderExtension {
}
...
export namespace ImageTextureLayered {
}
...
export namespace PacketPeerDTLS {export const enum Status {
  STATUS_DISCONNECTED = 0,
  STATUS_HANDSHAKING = 1,
  STATUS_CONNECTED = 2,
  STATUS_ERROR = 3,
...
export namespace CameraTexture {
}
...
export namespace GPUParticlesAttractorSphere3D {
}
...
export namespace SkinReference {
}
...
export namespace VisualShaderNodeScreenNormalWorldSpace {
}
...
export namespace VisualShaderNodeSmoothStep {export const enum OpType {
  OP_TYPE_SCALAR = 0,
  OP_TYPE_VECTOR_2D = 1,
  OP_TYPE_VECTOR_2D_SCALAR = 2,
  OP_TYPE_VECTOR_3D = 3,
...
export namespace VisualShaderNodeParticleSphereEmitter {
}
...
export namespace TextServerExtension {
}
...
export namespace AnimationNodeTransition {
}
...
export namespace VisualShaderNodeParameter {export const enum Qualifier {
  QUAL_NONE = 0,
  QUAL_GLOBAL = 1,
  QUAL_INSTANCE = 2,
  QUAL_MAX = 3,
...
export namespace VisualShaderNodeTexture2DParameter {
}
...
export namespace PolygonOccluder3D {
}
...
export namespace DisplayServer {export const enum Feature {
  FEATURE_GLOBAL_MENU = 0,
...
export const SCREEN_WITH_MOUSE_FOCUS = -4;
export const SCREEN_WITH_KEYBOARD_FOCUS = -3;
export const SCREEN_PRIMARY = -2;
export const SCREEN_OF_MAIN_WINDOW = -1;
export const MAIN_WINDOW_ID = 0;
export const INVALID_WINDOW_ID = -1;
export const INVALID_INDICATOR_ID = -1;
...
export const enum FileDialogMode {
...
export const enum TTSUtteranceEvent {
...
export namespace VisualShaderNodeTextureParameterTriplanar {
}


export interface Environment extends Resource {
  adjustment_brightness: type.float;
  adjustment_color_correction: { type: "Texture" , properties: Texture };
  ...
  glow_map: { type: "Texture" , properties: Texture };
...
export namespace Environment {export const enum BGMode {
  BG_CLEAR_COLOR = 0,
  BG_COLOR = 1,
  BG_SKY = 2,
  BG_CANVAS = 3,
...
export namespace RenderSceneBuffersExtension {
}
...
export namespace BoxOccluder3D {
}
...
export namespace CameraFeed {export const enum FeedDataType {
  FEED_NOIMAGE = 0,
  FEED_RGB = 1,
  FEED_YCBCR = 2,
  FEED_YCBCR_SEP = 3,
...
export const enum FeedPosition {
  FEED_UNSPECIFIED = 0,
  FEED_FRONT = 1,
  FEED_BACK = 2,
}
...
export namespace RenderSceneBuffersRD {
}


export interface Image extends Resource {
  data: { type: "Dictionary" , properties: Dictionary };  
}

export namespace Image {
export const MAX_WIDTH = 16777216;
export const MAX_HEIGHT = 16777216;
...
export const enum CompressMode {
  COMPRESS_S3TC = 0,
  COMPRESS_ETC = 1,
  COMPRESS_ETC2 = 2,
  COMPRESS_BPTC = 3,
...
export const enum UsedChannels {
  USED_CHANNELS_L = 0,
  USED_CHANNELS_LA = 1,
  USED_CHANNELS_R = 2,
  USED_CHANNELS_RG = 3,
...
export const enum CompressSource {
  COMPRESS_SOURCE_GENERIC = 0,
  COMPRESS_SOURCE_SRGB = 1,
  COMPRESS_SOURCE_NORMAL = 2,
}

export const enum ASTCFormat {
  ASTC_FORMAT_4x4 = 0,
  ASTC_FORMAT_8x8 = 1,
}
...
export namespace AudioEffectBandPassFilter {
}
...
export namespace VisualShaderNodeVectorLen {
}
...
export namespace VisualShaderNodeTextureParameter {export const enum TextureType {
  TYPE_DATA = 0,
  TYPE_COLOR = 1,
  TYPE_NORMAL_MAP = 2,
  TYPE_ANISOTROPY = 3,
...
export const enum ColorDefault {
...
export const enum TextureSource {
  SOURCE_NONE = 0,
  SOURCE_SCREEN = 1,
  SOURCE_DEPTH = 2,
...
export namespace SkeletonModification2DStackHolder {
}
...
export namespace VisualShaderNodeCompare {export const enum ComparisonType {
  CTYPE_SCALAR = 0,
  CTYPE_SCALAR_INT = 1,
  CTYPE_SCALAR_UINT = 2,
  CTYPE_VECTOR_2D = 3,
...
export interface ShaderMaterial extends Material {
  shader: { type: "Shader" , properties: Shader };  
}
...
export namespace Geometry2D {export const enum PolyBooleanOperation {
  OPERATION_UNION = 0,
...
export const enum PolyJoinType {
  JOIN_SQUARE = 0,
  JOIN_ROUND = 1,
  JOIN_MITER = 2,
}

export const enum PolyEndType {
  END_POLYGON = 0,
  END_JOINED = 1,
  END_BUTT = 2,
  END_SQUARE = 3,
...
export namespace PhysicsServer2DManager {
}
...
export namespace AudioListener3D {
}
...
export namespace TextServerDummy {
}
...
export namespace EditorVCSInterface {export const enum ChangeType {
  CHANGE_TYPE_NEW = 0,
...
export namespace PlaceholderTexture3D {
}
...
export namespace PackedScene {export const enum GenEditState {
  GEN_EDIT_STATE_DISABLED = 0,
  GEN_EDIT_STATE_INSTANCE = 1,
  GEN_EDIT_STATE_MAIN = 2,
  GEN_EDIT_STATE_MAIN_INHERITED = 3,
...
export namespace TileMapLayer {export const enum DebugVisibilityMode {
...
export namespace EditorFileSystem {
}
...
export namespace AudioEffectInstance {
}
...
export namespace EditorDebuggerSession {
}
...
export namespace VisualShaderNodeTransformConstant {
}
...
export type NodeTypeMap = {
  [K in NodeTypeNames]: { type: K; properties: NodeProperties[K] };
}
...
export type Node3DTypeMap = {
  [K in Node3DTypeNames]: { type: K; properties: Node3DProperties[K] };
}
...
export type CollisionObject3DTypeMap = {
  [K in CollisionObject3DTypeNames]: { type: K; properties: CollisionObject3DProperties[K] };
}
...
export type ResourceTypeMap = {
  [K in ResourceTypeNames]: { type: K; properties: ResourceProperties[K] };
}
...
export type TextureTypeMap = {
  [K in TextureTypeNames]: { type: K; properties: TextureProperties[K] };
}
...
export type MeshTypeMap = {
  [K in MeshTypeNames]: { type: K; properties: MeshProperties[K] };
}
...
export type Shape3DTypeMap = {
  [K in Shape3DTypeNames]: { type: K; properties: Shape3DProperties[K] };
}
