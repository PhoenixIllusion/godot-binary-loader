...
export abstract class Node {
  ...
  private static _typeMap: Record<string, NonAbstractConstructor<Node>> = {}
  static registerType(type: keyof AnimationNodeProperties, _class: NonAbstractConstructor<Node>) {
